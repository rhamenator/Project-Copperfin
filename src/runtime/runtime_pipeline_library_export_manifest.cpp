...
std::string build_native_wrapper_source(const RuntimePackagePlan& plan) {
    ...
    stream << "        command << \"cd \"\n";
    stream << "#endif\n";
    stream << "                << copperfin_runtime_bridge_quote_command_argument(copperfin_runtime_bridge_path_to_utf8_string(dispatch_execution.working_directory))\n";
    stream << "                << \" && \";\n";
    stream << "    }\n";
    ...
    stream << "#endif\n";
    stream << "    }\n";
    stream << "    command << copperfin_runtime_bridge_quote_command_argument(copperfin_runtime_bridge_path_to_utf8_string(dispatch_execution.executable_path));\n";
    ...
    stream << "        command << \" > \" << copperfin_runtime_bridge_quote_command_argument(copperfin_runtime_bridge_path_to_utf8_string(dispatch_execution.stdout_log_path));\n";
    stream << "    }\n";
    stream << "    if (dispatch_execution.capture_stderr && !dispatch_execution.stderr_log_path.empty()) {\n";
    stream << "        command << \" 2> \" << copperfin_runtime_bridge_quote_command_argument(copperfin_runtime_bridge_path_to_utf8_string(dispatch_execution.stderr_log_path));\n";
    stream << "    }\n";
