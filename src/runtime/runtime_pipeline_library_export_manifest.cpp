...
std::string build_native_wrapper_source(const RuntimePackagePlan& plan) {
    ...
    stream << "        STARTUPINFOW startup_info{};\n";
    stream << "        startup_info.cb = sizeof(startup_info);\n";
    stream << "        startup_info.dwFlags = STARTF_USESTDHANDLES;\n";
    stream << "        startup_info.hStdInput = GetStdHandle(STD_INPUT_HANDLE);\n";
    stream << "        startup_info.hStdOutput = stdout_handle == nullptr ? GetStdHandle(STD_OUTPUT_HANDLE) : stdout_handle;\n";
    stream << "        startup_info.hStdError = stderr_handle == nullptr ? GetStdHandle(STD_ERROR_HANDLE) : stderr_handle;\n";
    ...
    stream << "        process_created = CreateProcessW(\n";
    stream << "            nullptr,\n";
    stream << "            mutable_command_line.data(),\n";
    stream << "            nullptr,\n";
    stream << "            nullptr,\n";
    stream << "            TRUE,\n";
    stream << "            CREATE_UNICODE_ENVIRONMENT,\n";
