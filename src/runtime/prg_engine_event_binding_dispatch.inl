        ...
        bool *returned_false)
    {
        ...
        // #6420/#6550: a before-source handler can release the source. The
        // released object is parked rather than erased, so the source method
        // body still runs on it and its result is returned, as in VFP9.
