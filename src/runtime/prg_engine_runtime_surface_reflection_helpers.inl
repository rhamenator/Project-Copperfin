...
bool native_form_whats_this_button_member_name_matches(
    const RuntimeOleObjectState& runtime_object,
    const std::string& normalized_member_name) {
    if (normalized_member_name != "whatsthisbutton") {
        return false;
    }
...
bool native_form_sizebox_member_name_matches(
    const RuntimeOleObjectState& runtime_object,
    const std::string& normalized_member_name) {
    if (normalized_member_name != "sizebox") {
        return false;
    }
...
bool native_form_zoombox_member_name_matches(
    const RuntimeOleObjectState& runtime_object,
    const std::string& normalized_member_name) {
    if (normalized_member_name != "zoombox") {
        return false;
    }
...
bool native_visual_fontcharset_member_name_matches(
    const RuntimeOleObjectState& runtime_object,
    const std::string& normalized_member_name) {
    const std::string normalized_base_class = normalize_identifier(trim_copy(runtime_object.base_class_name));
    return normalized_member_name == "fontcharset" &&
           (is_native_visual_runtime_object(runtime_object) ||
            normalized_base_class == "column" || normalized_base_class == "header") &&
...
bool native_visual_dynamicfontshadow_member_name_matches(
    const RuntimeOleObjectState& runtime_object,
    const std::string& normalized_member_name) {
...
bool native_visual_dynamicfontoutline_member_name_matches(
    const RuntimeOleObjectState& runtime_object,
    const std::string& normalized_member_name) {
...
bool native_header_column_statusbartext_member_name_matches(
    const RuntimeOleObjectState& runtime_object,
    const std::string& normalized_member_name) {
    return normalized_member_name == "statusbartext" &&
           native_header_column_statusbartext_runtime_object(runtime_object) &&
           runtime_object.properties.contains("statusbartext");
}

bool native_header_column_mouseicon_member_name_matches(
    const RuntimeOleObjectState& runtime_object,
    const std::string& normalized_member_name) {
    return normalized_member_name == "mouseicon" &&
           native_header_column_mouseicon_runtime_object(runtime_object) &&
...
bool native_commandbutton_style_member_name_matches(
    const RuntimeOleObjectState& runtime_object,
    const std::string& normalized_member_name) {
    return normalized_member_name == "style" &&
           native_commandbutton_style_runtime_object(runtime_object) &&
...
bool native_column_dynamicalignment_member_name_matches(
    const RuntimeOleObjectState& runtime_object,
    const std::string& normalized_member_name) {
    return normalized_member_name == "dynamicalignment" &&
           native_column_dynamicalignment_runtime_object(runtime_object) &&
...
bool native_grid_linkmaster_member_name_matches(
    const RuntimeOleObjectState& runtime_object,
    const std::string& normalized_member_name) {
    if (normalized_member_name != "linkmaster" ||
...
bool native_grid_childorder_member_name_matches(
    const RuntimeOleObjectState& runtime_object,
    const std::string& normalized_member_name) {
    if (normalized_member_name != "childorder" ||
