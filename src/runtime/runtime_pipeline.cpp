...
std::string build_native_wrapper_source(const RuntimePackagePlan& plan) {
    ...
    stream << "        base_directory / (std::string(export_name) + \".stdout.log\"),\n";
    stream << "        base_directory / (std::string(export_name) + \".stderr.log\"),\n";
    stream << "        0};\n";
    stream << "}\n\n";
    ...
    stream << "        base_directory / (std::string(export_name) + \".request.json\"),\n";
    stream << "        base_directory / (std::string(export_name) + \".response.json\")};\n";
    stream << "}\n\n";
    ...
    stream << "        \"application/vnd.copperfin.runtime-bridge-request+json\",\n";
    ...
    stream << "        \"bridge_request_v1\",\n";
    stream << "        \"bridge_response_v1\",\n";
    ...
    stream << "        statement += \"(\";\n";
    stream << "        statement += int_value_representation;\n";
    stream << "        statement += \");\";\n";
