...
std::string build_native_wrapper_source(const RuntimePackagePlan& plan) {
    ...
    stream << "    return CopperfinRuntimeBridgeDispatchPlan{std::move(serialization_plan), std::move(stub_emission_wrapper), std::move(arguments)};\n";
    stream << "}\n\n";
