...
std::string build_native_wrapper_source(const RuntimePackagePlan& plan) {
    ...
    stream << "            placeholder_return_value_plan.stub_return_plan.stub_emission_wrapper.native_return_surface);\n";
    stream << "    return copperfin_runtime_bridge_apply_stub_emission_output(\n";
    stream << "        stub_emission_return_surface,\n";
    stream << "        placeholder_return_value_plan.stub_return_plan.stub_emission_wrapper.return_adapter);\n";
    stream << "}\n\n";
