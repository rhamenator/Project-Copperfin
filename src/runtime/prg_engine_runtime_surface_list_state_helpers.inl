...
bool native_visual_enabled_runtime_object(const RuntimeOleObjectState& runtime_object) {
    if (runtime_object.class_hierarchy.empty()) {
        return false;
    }
...
bool native_visual_righttoleft_runtime_object(const RuntimeOleObjectState& runtime_object) {
    if (runtime_object.class_hierarchy.empty()) {
        return false;
    }
...
bool native_visual_specialeffect_runtime_object(const RuntimeOleObjectState& runtime_object) {
    if (runtime_object.class_hierarchy.empty()) {
        return false;
    }
...
bool native_visual_fillcolor_runtime_object(const RuntimeOleObjectState& runtime_object) {
    if (runtime_object.class_hierarchy.empty()) {
        return false;
    }
...
bool native_visual_borderwidth_runtime_object(const RuntimeOleObjectState& runtime_object) {
    if (runtime_object.class_hierarchy.empty()) {
        return false;
    }
...
bool native_visual_bordercolor_runtime_object(const RuntimeOleObjectState& runtime_object) {
    if (runtime_object.class_hierarchy.empty()) {
        return false;
    }
    ...
    const std::string normalized_base_class =
        normalize_identifier(trim_copy(runtime_object.base_class_name));
    const std::string normalized_prog_id =
        normalize_identifier(trim_copy(runtime_object.prog_id));
    return normalized_base_class != "form" &&
           normalized_base_class != "olecontrol" &&
           normalized_prog_id != "olecontrol" &&
           is_native_visual_runtime_object(runtime_object);
}
...
bool native_grid_allowautocolumnfit_runtime_object(const RuntimeOleObjectState& runtime_object) {
    if (runtime_object.class_hierarchy.empty()) {
        return false;
    }
...
bool native_grid_gridlinecolor_runtime_object(const RuntimeOleObjectState& runtime_object) {
    if (runtime_object.class_hierarchy.empty()) {
        return false;
    }
...
bool native_grid_gridlinewidth_runtime_object(const RuntimeOleObjectState& runtime_object) {
    if (runtime_object.class_hierarchy.empty()) {
        return false;
    }
...
bool native_grid_highlightstyle_runtime_object(const RuntimeOleObjectState& runtime_object) {
    if (runtime_object.class_hierarchy.empty()) {
        return false;
    }
...
bool native_grid_highlightrowlinewidth_runtime_object(const RuntimeOleObjectState& runtime_object) {
    if (runtime_object.class_hierarchy.empty()) {
        return false;
    }
...
bool native_grid_view_runtime_object(const RuntimeOleObjectState& runtime_object) {
    if (runtime_object.class_hierarchy.empty()) {
        return false;
    }
...
bool native_grid_activecolumn_runtime_object(const RuntimeOleObjectState& runtime_object) {
    if (runtime_object.class_hierarchy.empty()) {
        return false;
    }
...
bool native_grid_activerow_runtime_object(const RuntimeOleObjectState& runtime_object) {
    if (runtime_object.class_hierarchy.empty()) {
        return false;
    }
...
bool native_grid_relativecolumn_runtime_object(const RuntimeOleObjectState& runtime_object) {
    if (runtime_object.class_hierarchy.empty()) {
        return false;
    }
...
bool native_grid_relativerow_runtime_object(const RuntimeOleObjectState& runtime_object) {
    if (runtime_object.class_hierarchy.empty()) {
        return false;
    }
...
bool native_column_dynamicalignment_runtime_object(const RuntimeOleObjectState& runtime_object) {
    if (runtime_object.class_hierarchy.empty()) {
        return false;
    }
...
bool native_column_sparse_runtime_object(const RuntimeOleObjectState& runtime_object) {
    if (runtime_object.class_hierarchy.empty()) {
        return false;
    }
...
bool native_header_column_statusbartext_runtime_object(const RuntimeOleObjectState& runtime_object) {
    if (runtime_object.class_hierarchy.empty()) {
        return false;
    }
...
bool native_header_column_mouseicon_runtime_object(const RuntimeOleObjectState& runtime_object) {
    if (runtime_object.class_hierarchy.empty()) {
        return false;
    }
