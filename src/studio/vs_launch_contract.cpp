...
LaunchParseResult parse_launch_arguments(
    ...
    for (std::size_t index = 0; index < args.size(); ++index) {
        ...
        if (argument == "--partition-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--partition-target-object-name")};
            }
        ...
        if (argument == "--partition-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--partition-target-unique-id")};
            }
            result.request.partition_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--record-source-type-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--record-source-type-target-object-name")};
            }
        ...
        if (argument == "--record-source-type-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--record-source-type-target-unique-id")};
            }
            result.request.record_source_type_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--column-order-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--column-order-target-object-name")};
            }
        ...
        if (argument == "--column-order-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--column-order-target-unique-id")};
            }
            result.request.column_order_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--highlight-style-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--highlight-style-target-object-name")};
            }
        ...
        if (argument == "--highlight-style-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--highlight-style-target-unique-id")};
            }
            result.request.highlight_style_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--child-order-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--child-order-target-object-name")};
            }
        ...
        if (argument == "--child-order-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--child-order-target-unique-id")};
            }
            result.request.child_order_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--fill-color-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--fill-color-target-object-name")};
            }
        ...
        if (argument == "--fill-color-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--fill-color-target-unique-id")};
            }
            result.request.fill_color_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--list-item-id-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--list-item-id-target-object-name")};
            }
        ...
        if (argument == "--list-item-id-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--list-item-id-target-unique-id")};
            }
            result.request.list_item_id_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--record-source-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--record-source-target-object-name")};
            }
        ...
        if (argument == "--record-source-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--record-source-target-unique-id")};
            }
            result.request.record_source_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--tooltip-text-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--tooltip-text-target-object-name")};
            }
        ...
        if (argument == "--tooltip-text-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--tooltip-text-target-unique-id")};
            }
            result.request.tooltip_text_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--status-bar-text-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--status-bar-text-target-object-name")};
            }
        ...
        if (argument == "--status-bar-text-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--status-bar-text-target-unique-id")};
            }
            result.request.status_bar_text_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--link-master-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--link-master-target-object-name")};
            }
        ...
        if (argument == "--link-master-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--link-master-target-unique-id")};
            }
            result.request.link_master_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--control-source-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--control-source-target-object-name")};
            }
        ...
        if (argument == "--control-source-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--control-source-target-unique-id")};
            }
            result.request.control_source_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--current-control-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--current-control-target-object-name")};
            }
        ...
        if (argument == "--current-control-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--current-control-target-unique-id")};
            }
            result.request.current_control_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--input-mask-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--input-mask-target-object-name")};
            }
        ...
        if (argument == "--input-mask-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--input-mask-target-unique-id")};
            }
            result.request.input_mask_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--format-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--format-target-object-name")};
            }
        ...
        if (argument == "--format-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--format-target-unique-id")};
            }
            result.request.format_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--row-source-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--row-source-target-object-name")};
            }
        ...
        if (argument == "--row-source-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--row-source-target-unique-id")};
            }
            result.request.row_source_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--column-widths-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--column-widths-target-object-name")};
            }
        ...
        if (argument == "--column-widths-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--column-widths-target-unique-id")};
            }
            result.request.column_widths_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--column-lines-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--column-lines-target-object-name")};
            }
        ...
        if (argument == "--column-lines-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--column-lines-target-unique-id")};
            }
            result.request.column_lines_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--integral-height-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--integral-height-target-object-name")};
            }
        ...
        if (argument == "--integral-height-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--integral-height-target-unique-id")};
            }
            result.request.integral_height_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--incremental-search-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--incremental-search-target-object-name")};
            }
        ...
        if (argument == "--incremental-search-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--incremental-search-target-unique-id")};
            }
            result.request.incremental_search_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--multi-select-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--multi-select-target-object-name")};
            }
        ...
        if (argument == "--multi-select-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--multi-select-target-unique-id")};
            }
            result.request.multi_select_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--row-source-type-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--row-source-type-target-object-name")};
            }
        ...
        if (argument == "--row-source-type-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--row-source-type-target-unique-id")};
            }
            result.request.row_source_type_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--bound-column-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--bound-column-target-object-name")};
            }
        ...
        if (argument == "--bound-column-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--bound-column-target-unique-id")};
            }
            result.request.bound_column_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--column-count-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--column-count-target-object-name")};
            }
        ...
        if (argument == "--column-count-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--column-count-target-unique-id")};
            }
            result.request.column_count_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--style-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--style-target-object-name")};
            }
        ...
        if (argument == "--style-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--style-target-unique-id")};
            }
            result.request.style_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--list-index-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--list-index-target-object-name")};
            }
        ...
        if (argument == "--list-index-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--list-index-target-unique-id")};
            }
            result.request.list_index_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--left-column-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--left-column-target-object-name")};
            }
        ...
        if (argument == "--left-column-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--left-column-target-unique-id")};
            }
            result.request.left_column_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--display-value-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--display-value-target-object-name")};
            }
        ...
        if (argument == "--display-value-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--display-value-target-unique-id")};
            }
            result.request.display_value_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--closable-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--closable-target-object-name")};
            }
        ...
        if (argument == "--closable-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--closable-target-unique-id")};
            }
            result.request.closable_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--control-box-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--control-box-target-object-name")};
            }
        ...
        if (argument == "--control-box-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--control-box-target-unique-id")};
            }
            result.request.control_box_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--allow-output-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--allow-output-target-object-name")};
            }
        ...
        if (argument == "--allow-output-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--allow-output-target-unique-id")};
            }
            result.request.allow_output_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--auto-center-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--auto-center-target-object-name")};
            }
        ...
        if (argument == "--auto-center-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--auto-center-target-unique-id")};
            }
            result.request.auto_center_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--auto-verb-menu-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--auto-verb-menu-target-object-name")};
            }
        ...
        if (argument == "--auto-verb-menu-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--auto-verb-menu-target-unique-id")};
            }
            result.request.auto_verb_menu_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--bind-controls-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--bind-controls-target-object-name")};
            }
        ...
        if (argument == "--bind-controls-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--bind-controls-target-unique-id")};
            }
            result.request.bind_controls_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--desktop-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--desktop-target-object-name")};
            }
        ...
        if (argument == "--desktop-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--desktop-target-unique-id")};
            }
            result.request.desktop_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--key-preview-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--key-preview-target-object-name")};
            }
        ...
        if (argument == "--key-preview-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--key-preview-target-unique-id")};
            }
            result.request.key_preview_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--mac-desktop-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--mac-desktop-target-object-name")};
            }
        ...
        if (argument == "--mac-desktop-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--mac-desktop-target-unique-id")};
            }
            result.request.mac_desktop_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--max-button-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--max-button-target-object-name")};
            }
        ...
        if (argument == "--max-button-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--max-button-target-unique-id")};
            }
            result.request.max_button_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--min-button-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--min-button-target-object-name")};
            }
        ...
        if (argument == "--min-button-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--min-button-target-unique-id")};
            }
            result.request.min_button_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--max-width-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--max-width-target-object-name")};
            }
        ...
        if (argument == "--max-width-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--max-width-target-unique-id")};
            }
            result.request.max_width_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--max-left-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--max-left-target-object-name")};
            }
        ...
        if (argument == "--max-left-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--max-left-target-unique-id")};
            }
            result.request.max_left_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--max-top-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--max-top-target-object-name")};
            }
        ...
        if (argument == "--max-top-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--max-top-target-unique-id")};
            }
            result.request.max_top_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--auto-size-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--auto-size-target-object-name")};
            }
        ...
        if (argument == "--auto-size-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--auto-size-target-unique-id")};
            }
            result.request.auto_size_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--auto-release-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--auto-release-target-object-name")};
            }
        ...
        if (argument == "--auto-release-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--auto-release-target-unique-id")};
            }
            result.request.auto_release_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--continuous-scroll-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--continuous-scroll-target-object-name")};
            }
        ...
        if (argument == "--continuous-scroll-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--continuous-scroll-target-unique-id")};
            }
            result.request.continuous_scroll_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--dockable-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--dockable-target-object-name")};
            }
        ...
        if (argument == "--dockable-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--dockable-target-unique-id")};
            }
            result.request.dockable_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--clip-controls-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--clip-controls-target-object-name")};
            }
        ...
        if (argument == "--clip-controls-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--clip-controls-target-unique-id")};
            }
            result.request.clip_controls_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--sparse-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--sparse-target-object-name")};
            }
        ...
        if (argument == "--sparse-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--sparse-target-unique-id")};
            }
            result.request.sparse_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--lock-screen-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--lock-screen-target-object-name")};
            }
        ...
        if (argument == "--lock-screen-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--lock-screen-target-unique-id")};
            }
            result.request.lock_screen_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--allow-cell-selection-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--allow-cell-selection-target-object-name")};
            }
        ...
        if (argument == "--allow-cell-selection-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--allow-cell-selection-target-unique-id")};
            }
            result.request.allow_cell_selection_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--hide-selection-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--hide-selection-target-object-name")};
            }
        ...
        if (argument == "--hide-selection-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--hide-selection-target-unique-id")};
            }
            result.request.hide_selection_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--delete-mark-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--delete-mark-target-object-name")};
            }
        ...
        if (argument == "--delete-mark-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--delete-mark-target-unique-id")};
            }
            result.request.delete_mark_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--record-mark-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--record-mark-target-object-name")};
            }
        ...
        if (argument == "--record-mark-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--record-mark-target-unique-id")};
            }
            result.request.record_mark_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--split-bar-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--split-bar-target-object-name")};
            }
        ...
        if (argument == "--split-bar-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--split-bar-target-unique-id")};
            }
            result.request.split_bar_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--highlight-row-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--highlight-row-target-object-name")};
            }
        ...
        if (argument == "--highlight-row-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--highlight-row-target-unique-id")};
            }
            result.request.highlight_row_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--panel-link-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--panel-link-target-object-name")};
            }
        ...
        if (argument == "--panel-link-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--panel-link-target-unique-id")};
            }
            result.request.panel_link_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--allow-header-sizing-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--allow-header-sizing-target-object-name")};
            }
        ...
        if (argument == "--allow-header-sizing-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--allow-header-sizing-target-unique-id")};
            }
            result.request.allow_header_sizing_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--allow-row-sizing-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--allow-row-sizing-target-object-name")};
            }
        ...
        if (argument == "--allow-row-sizing-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--allow-row-sizing-target-unique-id")};
            }
            result.request.allow_row_sizing_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--resizable-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--resizable-target-object-name")};
            }
        ...
        if (argument == "--resizable-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--resizable-target-unique-id")};
            }
            result.request.resizable_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--add-line-feeds-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--add-line-feeds-target-object-name")};
            }
        ...
        if (argument == "--add-line-feeds-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--add-line-feeds-target-unique-id")};
            }
            result.request.add_line_feeds_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--always-on-top-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--always-on-top-target-object-name")};
            }
        ...
        if (argument == "--always-on-top-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--always-on-top-target-unique-id")};
            }
            result.request.always_on_top_objects.push_back({
                .record_index = 0U,
                .object_name = {},
        ...
        if (argument == "--always-on-bottom-target-object-name") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--always-on-bottom-target-object-name")};
            }
        ...
        if (argument == "--always-on-bottom-target-unique-id") {
            if ((index + 1U) >= args.size()) {
                return {.ok = false, .error = localized_missing_value_after_option(catalog, "--always-on-bottom-target-unique-id")};
            }
            result.request.always_on_bottom_objects.push_back({
                .record_index = 0U,
                .object_name = {},
