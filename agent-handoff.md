...
- Last shipped localization child: `#2490`, native security profile display/policy prose routes through the portable C++ localization catalog while preserving permission ids, role ids, provider ids/kinds, feature ids, audit event ids, manifest contracts, authorization behavior, and default en-US output.
