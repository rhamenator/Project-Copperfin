...
- Last shipped localization child: `#2541`, expression evaluator runtime errors for integer division-by-zero, general division-by-zero, and missing function arguments route through the portable C++ localization catalog while preserving parser tokens, source function names, diagnostic identities, runtime state fields, event categories, and default en-US output.
