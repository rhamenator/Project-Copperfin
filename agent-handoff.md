...
- Last shipped localization child: `#2547`, record table-maintenance local table-backed cursor errors route through the portable C++ localization catalog while preserving VFP command names, parser behavior, cursor state, event categories, machine-readable state, and default en-US output.
