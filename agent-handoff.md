...
- Next action: inspect live `#24` children or create the next prompt-sized E3 slice from current real gaps, with remaining likely seams around report/label grouping or sorting metadata beyond stable, record-selected, and nested EXPR-edit evidence, shared host/designer round-trip fidelity, report/label runtime-preview hooks, and any other FRX/LBX behavior the live issue tree still shows as unproven.
