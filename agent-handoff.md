...
- Last shipped localization child: `#2388`, security subsystem diagnostics routed through the portable C++ localization catalog while preserving environment variable names, paths, executable names, policy identifiers, hashes, audit fields, enum values, and platform/API identifiers.
