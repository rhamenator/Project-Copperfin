...
- Last shipped localization child: `#2445`, Studio launch max/auto behavior validation diagnostics route through the portable C++ localization catalog while preserving CLI option names, JSON/status contracts, numeric/boolean semantics, parser behavior, and default en-US output.
