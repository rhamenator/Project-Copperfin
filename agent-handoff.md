...
- Last shipped localization child: `#2496`, Studio project workspace item type titles and group titles route through the portable C++ localization catalog while preserving project item type codes, group ids, file extensions, paths, field names, memo provenance, field indexes, record selection behavior, build-plan behavior, and default en-US output.
