...
- Last shipped localization child: `#2377`, visual asset editor storage, memo sidecar, undo-journal, selected-field exposure, property source/target, and method-name validation prose routed through the portable C++ localization catalog while preserving DBF field names, VFP property/method identifiers, file extensions, record indexes, boolean literals, and JSON contracts.
