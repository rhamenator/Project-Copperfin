...
- Last shipped localization child: `#2495`, Studio project workspace build-plan target labels route through the portable C++ localization catalog while preserving `output_kind` machine values, project item type codes, paths, field names, memo provenance, field indexes, record selection behavior, and default en-US output.
