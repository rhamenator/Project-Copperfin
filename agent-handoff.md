...
- Last shipped localization child: `#2448`, Studio launch command-mode validation diagnostics route through the portable C++ localization catalog while preserving CLI option names, JSON/status contracts, command exclusivity semantics, parser behavior, and default en-US output.
