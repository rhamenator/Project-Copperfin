...
- Last shipped localization child: `#2471`, Studio launch drawing and buffer target selector value diagnostics route through the portable C++ localization catalog while preserving CLI option names, drawing/buffer selector assignment semantics, JSON/status contracts, parser behavior, and default en-US output.
