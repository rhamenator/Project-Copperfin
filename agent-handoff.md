...
- Last shipped localization child: `#2386`, asset inspector missing path and DBC export error prose routed through the portable C++ localization catalog while preserving asset family values, severity values, JSON contracts, file extensions, and validation codes.
