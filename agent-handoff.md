...
- Last shipped localization child: `#2528`, runtime `TOTAL` command parser and execution error prose routes through the portable C++ localization catalog while preserving FoxPro/VFP command syntax, work-area targeting, field names, cursor behavior, runtime error control flow, and default en-US output.
