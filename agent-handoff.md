...
- Last shipped localization child: `#2420`, Studio host toolbox batch-plan-catalog parser diagnostics route through the portable C++ localization catalog while preserving CLI options, command names, toolbox/selection-context tokens, JSON fields/status contracts, `name=value` syntax, and exit codes.
