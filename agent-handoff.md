...
- Last shipped localization child: `#2491`, database federation profile display/prose routes through the portable C++ localization catalog while preserving connector ids/family values, query path ids, booleans, API behavior, and default en-US output.
