...
- Last shipped localization child: `#2544`, runtime surface object/member stub and fallback warnings route through the portable C++ localization catalog while preserving VFP function names, callback capability tokens, runtime event categories, parser behavior, machine-readable state, and default en-US output.
