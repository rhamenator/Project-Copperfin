...
- Last shipped localization child: `#2550`, native DLL proc-address errors route through the portable C++ localization catalog while preserving declared function names, DLL paths, interop event categories, parser behavior, machine-readable state, and default en-US output.
