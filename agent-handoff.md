...
- Last shipped localization child: `#2432`, Studio launch grid layout validation diagnostics route through the portable C++ localization catalog while preserving CLI option names, JSON/status contracts, parser semantics, and default en-US output.
