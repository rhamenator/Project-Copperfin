...
- Last shipped localization child: `#2465`, Studio launch color value diagnostics route through the portable C++ localization catalog while preserving CLI option names, color assignment semantics, JSON/status contracts, parser behavior, and default en-US output.
