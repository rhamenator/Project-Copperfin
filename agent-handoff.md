...
- Last shipped localization child: `#2481`, Studio launch window and picture target selector diagnostics route through the portable C++ localization catalog while preserving CLI option names, window/display and picture-layout assignment semantics, JSON/status contracts, parser behavior, and default en-US output.
