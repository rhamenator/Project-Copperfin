...
- Last shipped localization child: `#2503`, Studio launch align/alignment, resize, distribution, snap, and nudge diagnostic labels route through the portable C++ localization catalog while preserving CLI option names, layout action command tokens, mode values, JSON/status contracts, parser behavior, mutation safety, and default en-US output.
