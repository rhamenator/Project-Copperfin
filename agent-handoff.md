...
- Last shipped localization child: `#2483`, Studio launch font target selector diagnostics route through the portable C++ localization catalog while preserving CLI option names, font assignment semantics, JSON/status contracts, parser behavior, and default en-US output.
