...
- Last shipped localization child: `#2392`, xAsset executable-model missing table-preview and unsupported-family diagnostics routed through the portable C++ localization catalog while preserving xAsset family identifiers, DBF fields, action identifiers, generated routine names, file extensions, JSON keys, and runtime contracts.
