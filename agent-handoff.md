...
- Last shipped localization child: `#2453`, Studio launch drag/OLE value diagnostics route through the portable C++ localization catalog while preserving CLI option names, drag/OLE/drop numeric parsing semantics, JSON/status contracts, parser behavior, and default en-US output.
