...
- Last shipped localization child: `#2485`, Studio launch marker and z-order target selector diagnostics route through the portable C++ localization catalog while preserving CLI option names, marker/sizing/z-order assignment semantics, JSON/status contracts, parser behavior, and default en-US output.
