...
- Last shipped localization child: `#2384`, DBF table append and record field replacement error prose routed through the portable C++ localization catalog while preserving DBF field identifiers, memo sidecar formats, and machine-readable contracts.
