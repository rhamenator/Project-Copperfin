...
- Last shipped localization child: `#2472`, Studio launch grid target selector value diagnostics route through the portable C++ localization catalog while preserving CLI option names, grid selector assignment semantics, JSON/status contracts, parser behavior, and default en-US output.
