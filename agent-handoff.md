...
- Last shipped localization child: `#2487`, Studio launch extended form metadata diagnostics route through the portable C++ localization catalog while preserving CLI option names, form metadata/help assignment semantics, JSON/status contracts, parser behavior, and default en-US output.
