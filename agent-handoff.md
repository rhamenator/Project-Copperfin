...
- Last shipped localization child: `#2441`, Studio launch form bounds/style validation diagnostics route through the portable C++ localization catalog while preserving CLI option names, JSON/status contracts, numeric semantics, parser behavior, and default en-US output.
