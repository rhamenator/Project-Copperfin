...
- Last shipped localization child: `#2470`, Studio launch OLE drop and drawing target selector value diagnostics route through the portable C++ localization catalog while preserving CLI option names, OLE drop/drawing selector assignment semantics, JSON/status contracts, parser behavior, and default en-US output.
