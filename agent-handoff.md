...
- Last shipped localization child: `#2447`, Studio launch sizing/z-order validation diagnostics route through the portable C++ localization catalog while preserving CLI option names, JSON/status contracts, boolean semantics, parser behavior, and default en-US output.
