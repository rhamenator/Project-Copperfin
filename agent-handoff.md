...
- Last shipped localization child: `#2370`, aggregate Studio designer invocation-admission validation prose routed through the portable C++ localization catalog while preserving selection-context tokens, action ids, builder ids, toolbox item ids, command tokens, counts, dry-run state, mutation state, and JSON contracts.
