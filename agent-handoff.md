...
- Last shipped localization child: `#2382`, DBF table parse/open, table creation, and initial table/memo write error prose routed through the portable C++ localization catalog while preserving DBF field type identifiers, file formats, and machine-readable contracts.
