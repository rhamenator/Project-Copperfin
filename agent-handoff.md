...
- Last shipped localization child: `#2527`, PRG static-analysis diagnostic message prose routes through the portable C++ localization catalog while preserving diagnostic codes, severity values, file/line locations, parser behavior, FoxPro/VFP syntax tokens, and default en-US output.
