...
- Last shipped localization child: `#2501`, Studio launch `--selection-context` allowed-values list grammar routes through the portable C++ localization catalog while preserving selection-context tokens, CLI option names, JSON/status contracts, parser behavior, and default en-US output.
