...
- Last shipped localization child: `#2477`, Studio launch deleted-state value diagnostics route through the portable C++ localization catalog while preserving CLI option names, true/false tokens, deleted-state assignment semantics, JSON/status contracts, parser behavior, and default en-US output.
