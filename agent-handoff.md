...
- Last shipped localization child: `#2455`, Studio launch grid value diagnostics route through the portable C++ localization catalog while preserving CLI option names, grid/header/row numeric parsing semantics, JSON/status contracts, parser behavior, and default en-US output.
