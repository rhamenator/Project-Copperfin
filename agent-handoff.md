...
- Last shipped localization child: `#2473`, Studio launch partition and list target selector value diagnostics route through the portable C++ localization catalog while preserving CLI option names, partition/list selector assignment semantics, JSON/status contracts, parser behavior, and default en-US output.
