...
- Last shipped localization child: `#2551`, runtime cancellation and top-level runtime fault messages route through the portable C++ localization catalog while preserving event categories, debug pause reasons, exception detail values, parser behavior, machine-readable state, and default en-US output.
