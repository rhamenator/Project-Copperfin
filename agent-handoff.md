...
- Last shipped localization child: `#2545`, runtime surface cursor XML warnings route through the portable C++ localization catalog while preserving VFP function names, cursor callback capability tokens, runtime event categories, parser behavior, path handling, machine-readable state, and default en-US output.
