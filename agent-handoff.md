...
- Last shipped localization child: `#2458`, Studio launch window flag value diagnostics route through the portable C++ localization catalog while preserving CLI option names, boolean parsing semantics, JSON/status contracts, parser behavior, and default en-US output.
