...
- Last shipped localization child: `#2532`, SQL missing-handle and empty `SQLEXEC` errors route through the portable C++ localization catalog while preserving SQL function names, handle/session semantics, AERROR details, runtime error control flow, and default en-US output.
