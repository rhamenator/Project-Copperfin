...
- Last shipped localization child: `#2482`, Studio launch dynamic target selector diagnostics route through the portable C++ localization catalog while preserving CLI option names, dynamic expression/font assignment semantics, JSON/status contracts, parser behavior, and default en-US output.
