...
- Last shipped localization child: `#2374`, visual asset editor geometry field, distribution, snapping, nudging, tab-order, finite font-size, and non-negative numeric property validation prose routed through the portable C++ localization catalog while preserving property identifiers, DBF field names, geometry values, operation tokens, record indexes, and JSON contracts.
