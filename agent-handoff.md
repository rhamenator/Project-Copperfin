...
- Last shipped localization child: `#2553`, async task dispatch validation errors route through the portable C++ localization catalog while preserving VFP command names, task handles, targets, event categories, parser behavior, machine-readable state, and default en-US output.
