...
- Last shipped localization child: `#2383`, DBF table add/drop/alter schema mutation validation prose routed through the portable C++ localization catalog while preserving DBF field identifiers, file formats, and machine-readable contracts.
