...
- Last shipped localization child: `#2454`, Studio launch drawing/buffer value diagnostics route through the portable C++ localization catalog while preserving CLI option names, drawing/buffer/session numeric parsing semantics, JSON/status contracts, parser behavior, and default en-US output.
