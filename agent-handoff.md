...
- Last shipped localization child: `#2462`, Studio launch font value diagnostics route through the portable C++ localization catalog while preserving CLI option names, font assignment semantics, JSON/status contracts, parser behavior, and default en-US output.
