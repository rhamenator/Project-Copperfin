...
- Last shipped localization child: `#2463`, Studio launch max/auto selection value diagnostics route through the portable C++ localization catalog while preserving CLI option names, max/auto/selection assignment semantics, JSON/status contracts, parser behavior, and default en-US output.
