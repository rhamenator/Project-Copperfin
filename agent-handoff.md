...
- Last shipped localization child: `#2449`, Studio launch core argument value diagnostics route through the portable C++ localization catalog while preserving CLI option names, selection-context tokens, syntax tokens, JSON/status contracts, parser behavior, and default en-US output.
