...
- Last shipped localization child: `#2488`, Studio launch residual core parse diagnostics route through the portable C++ localization catalog while preserving CLI option names, command names, argument text, allowed mode tokens, JSON/status contracts, parser behavior, and default en-US output.
