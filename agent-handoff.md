...
- Last shipped localization child: `#2521`, Studio launch dynamic assignment diagnostic labels route through the portable C++ localization catalog while preserving CLI option names, assignment flags, expression text, JSON/status contracts, parser behavior, mutation safety, and default en-US output.
