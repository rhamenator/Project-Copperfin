...
- Last shipped localization child: `#2389`, platform profile query/federation diagnostics routed through the portable C++ localization catalog while preserving SQL syntax, backend identifiers, federation mode values, planning modes, JSON/schema keys, and machine-readable contracts.
