...
- Last shipped localization child: `#2479`, Studio launch form boolean target selector diagnostics route through the portable C++ localization catalog while preserving CLI option names, boolean assignment semantics, JSON/status contracts, parser behavior, and default en-US output.
