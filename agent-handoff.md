...
- Last shipped localization child: `#2531`, runtime cursor `USE` and `SEEK` errors route through the portable C++ localization catalog while preserving FoxPro/VFP cursor/search syntax, cursor state, order/search behavior, runtime error control flow, and default en-US output.
