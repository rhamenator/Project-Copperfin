...
- Last shipped localization child: `#2469`, Studio launch mouse and drag target selector value diagnostics route through the portable C++ localization catalog while preserving CLI option names, mouse/drag selector assignment semantics, JSON/status contracts, parser behavior, and default en-US output.
