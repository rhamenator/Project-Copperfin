...
- Last shipped localization child: `#2452`, Studio launch list scalar value diagnostics route through the portable C++ localization catalog while preserving CLI option names, list scalar parsing semantics, JSON/status contracts, parser behavior, and default en-US output.
