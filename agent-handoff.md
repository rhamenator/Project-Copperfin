...
- Last shipped localization child: `#2387`, asset inspector DBF, memo sidecar, DBC catalog, and companion index validation prose routed through the portable C++ localization catalog while preserving validation codes, severity values, asset family values, JSON contracts, file extensions, and VFP/DBF field identifiers.
