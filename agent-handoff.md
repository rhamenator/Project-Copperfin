...
- Last shipped localization child: `#2460`, Studio launch form appearance value diagnostics route through the portable C++ localization catalog while preserving CLI option names, numeric parsing semantics, JSON/status contracts, parser behavior, and default en-US output.
