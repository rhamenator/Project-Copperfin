...
- Last shipped localization child: `#2369`, selection-context builder launch, invocation-admission catalog, dispatch catalog, and dispatch execution-readiness prose routed through the portable C++ localization catalog while preserving selection-context tokens, builder ids, command tokens, entry points, dispatch state, counts, and JSON contracts.
