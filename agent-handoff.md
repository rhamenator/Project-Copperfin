...
- Last shipped localization child: `#2429`, Studio launch read-only, locked, caption, picture, down-picture, and disabled-picture validation diagnostics route through the portable C++ localization catalog while preserving CLI option names, JSON/status contracts, parser semantics, and default en-US output.
