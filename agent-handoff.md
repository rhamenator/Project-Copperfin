...
- Last shipped localization child: `#2457`, Studio launch display/dynamic color value diagnostics route through the portable C++ localization catalog while preserving CLI option names, string assignment semantics, JSON/status contracts, parser behavior, and default en-US output.
