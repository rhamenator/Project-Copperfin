...
- Last shipped localization child: `#2478`, Studio launch color target selector value diagnostics route through the portable C++ localization catalog while preserving CLI option names, color/dynamic-color assignment semantics, JSON/status contracts, parser behavior, and default en-US output.
