...
- Last shipped localization child: `#2486`, Studio launch core selector and undo missing-value diagnostics route through the portable C++ localization catalog while preserving CLI option names, object selector/source-location/undo assignment semantics, JSON/status contracts, parser behavior, and default en-US output.
