...
- Last shipped localization child: `#2526`, runtime Rushmore/index-seek pattern reasons, candidate match reasons, and plan decision rationale text route through the portable C++ localization catalog while preserving optimizer enums, field/order identifiers, runtime planning behavior, event/detail contracts, and default en-US output.
