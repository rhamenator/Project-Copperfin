...
- Last shipped localization child: `#2504`, Studio launch update, clear, and rename property-command diagnostic labels route through the portable C++ localization catalog while preserving CLI option names, property command flags, JSON/status contracts, parser behavior, mutation safety, and default en-US output.
