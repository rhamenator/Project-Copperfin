...
- Last shipped localization child: `#2484`, Studio launch max and selection target selector diagnostics route through the portable C++ localization catalog while preserving CLI option names, max/auto/selection assignment semantics, JSON/status contracts, parser behavior, and default en-US output.
