...
- Last shipped localization child: `#2427`, Studio launch layout action validation diagnostics for align, resize, distribute, snap, and nudge route through the portable C++ localization catalog while preserving CLI option names, JSON/status contracts, parser semantics, and default en-US output.
