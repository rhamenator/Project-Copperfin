...
- Last shipped localization child: `#2440`, Studio launch window flag validation diagnostics route through the portable C++ localization catalog while preserving CLI option names, JSON/status contracts, parser semantics, and default en-US output.
