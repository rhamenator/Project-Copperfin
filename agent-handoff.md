...
- Last shipped localization child: `#2443`, Studio launch dynamic expression validation diagnostics route through the portable C++ localization catalog while preserving CLI option names, JSON/status contracts, dynamic expression semantics, parser behavior, and default en-US output.
