...
- Last shipped localization child: `#2549`, .NET CLR interop errors route through the portable C++ localization catalog while preserving COM/CLR API names, HRESULT values, assembly paths, type and method names, interop event categories, parser behavior, machine-readable state, and default en-US output.
