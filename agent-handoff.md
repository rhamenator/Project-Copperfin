...
- Last shipped E3 child: `#3011`, shared report/label shell-summary deleted-count exposure; the shared VSIX/standalone FRX/LBX shell summary now surfaces deleted section, deleted settings, and deleted object counts alongside the existing live section, grouping, settings, and unplaced-object totals while preserving host JSON and machine-readable contracts, and focused designer smokes now prove the expanded summary routing for `en-US`, `es-419`, `pt-BR`, and `qps-ploc`.
