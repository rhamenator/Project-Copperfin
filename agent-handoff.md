...
- Last shipped localization child: `#2480`, Studio launch dimension and border target selector diagnostics route through the portable C++ localization catalog while preserving CLI option names, dimension/border assignment semantics, JSON/status contracts, parser behavior, and default en-US output.
