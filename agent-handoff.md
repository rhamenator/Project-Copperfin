...
- Last shipped localization child: `#2500`, visual asset editor unavailable-created-group-container error prose routes through the portable C++ localization catalog while preserving visual object ids, object names, unique ids, parent names, field names, grouping/container creation/rollback behavior, table and memo write behavior, and default en-US output.
