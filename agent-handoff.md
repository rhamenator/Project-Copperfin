...
- Last shipped localization child: `#2494`, DBF-family header version/type prose routes through the portable C++ localization catalog while preserving DBF version bytes, parse behavior, diagnostic keys, asset-inspection contracts, FoxPro/VFP semantics, and default en-US output.
