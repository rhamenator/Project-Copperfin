...
- Last shipped localization child: `#2475`, Studio launch row source list target selector value diagnostics route through the portable C++ localization catalog while preserving CLI option names, row-source/list selector assignment semantics, JSON/status contracts, parser behavior, and default en-US output.
