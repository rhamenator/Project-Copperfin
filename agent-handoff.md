...
- Last shipped localization child: `#2529`, aggregate `CALCULATE` and `COUNT TO` error prose routes through the portable C++ localization catalog while preserving FoxPro/VFP command syntax, aggregate semantics, variable targeting, runtime error control flow, and default en-US output.
