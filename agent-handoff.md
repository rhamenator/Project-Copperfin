...
- Last shipped localization child: `#2421`, Studio host toolbox plan-catalog parser diagnostics route through the portable C++ localization catalog while preserving CLI options, command names, toolbox/selection-context tokens, JSON fields/status contracts, `name=value` syntax, and exit codes.
