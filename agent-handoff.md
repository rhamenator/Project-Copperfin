...
- Last shipped localization child: `#2546`, record constraint and `INSERT INTO` validation errors route through the portable C++ localization catalog while preserving VFP command names, field names, parser behavior, cursor state, event categories, machine-readable state, and default en-US output.
