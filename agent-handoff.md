...
- Last shipped localization child: `#2379`, DBF/CDX header parse, open, read, and probe error prose routed through the portable C++ localization catalog while preserving xBase/FoxPro format identifiers, file extensions, parser tokens, schema keys, and machine-readable contracts.
