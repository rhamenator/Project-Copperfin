...
- Last shipped localization child: `#2385`, DBF table deleted-flag, truncate, pack, memo-pack, and zap row/header mutation error prose routed through the portable C++ localization catalog while preserving DBF file formats and machine-readable contracts.
