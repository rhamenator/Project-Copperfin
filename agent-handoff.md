...
- Last shipped localization child: `#2435`, Studio launch row/list validation diagnostics route through the portable C++ localization catalog while preserving CLI option names, JSON/status contracts, parser semantics, and default en-US output.
