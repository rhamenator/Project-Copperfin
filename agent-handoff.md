...
- Last shipped localization child: `#2552`, xAsset bootstrap materialization failures route through the portable C++ localization catalog while preserving asset paths, generated bootstrap names, xAsset identifiers, event categories, parser behavior, machine-readable state, and default en-US output.
