...
- Last shipped localization child: `#2393`, Studio document-open missing path diagnostics routed through the portable C++ localization catalog while preserving paths, asset family identifiers, DBF fields, JSON keys, CLI options, and host contracts.
