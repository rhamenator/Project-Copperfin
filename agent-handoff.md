...
- Last shipped localization child: `#2378`, remaining visual asset editor subtree duplicate, group container, and ungroup container validation prose routed through the portable C++ localization catalog while preserving DBF field names, object identities, record indexes, and JSON contracts.
