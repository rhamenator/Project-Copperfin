...
- Last shipped localization child: `#2428`, Studio launch tab-order, tab-stop, visibility, and enabled validation diagnostics route through the portable C++ localization catalog while preserving CLI option names, JSON/status contracts, parser semantics, and default en-US output.
