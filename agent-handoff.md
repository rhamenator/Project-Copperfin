...
- Last shipped localization child: `#2381`, DBF table record/value validation prose routed through the portable C++ localization catalog while preserving DBF field types, field names, format examples, file formats, and machine-readable contracts.
