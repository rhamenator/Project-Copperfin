...
- Last shipped localization child: `#2492`, extensibility profile display/prose routes through the portable C++ localization catalog while preserving language ids, AI feature ids, parity ids, reason tags, allowlist/denylist ids, verification references, enum values, booleans, policy behavior, and default en-US output.
