...
- Last shipped localization child: `#2456`, Studio launch record/list value diagnostics route through the portable C++ localization catalog while preserving CLI option names, record/list numeric parsing semantics, JSON/status contracts, parser behavior, and default en-US output.
