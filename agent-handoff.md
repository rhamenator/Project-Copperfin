...
- Last shipped localization child: `#2464`, Studio launch marker/sizing/z-order value diagnostics route through the portable C++ localization catalog while preserving CLI option names, marker/sizing/z-order assignment semantics, JSON/status contracts, parser behavior, and default en-US output.
