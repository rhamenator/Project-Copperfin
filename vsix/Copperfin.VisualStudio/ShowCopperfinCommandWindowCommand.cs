...
internal sealed class ShowCopperfinCommandWindowCommand
{
    private const int CommandId = 0x0300;
    private static readonly Guid CommandSet = new(PackageGuids.CommandSetString);
    private readonly AsyncPackage package;

    private ShowCopperfinCommandWindowCommand(AsyncPackage package, OleMenuCommandService commandService)
    {
        ...
        {
            Text = CopperfinLocalization.FromVisualStudioUiCulture().Text("VSIX.CommandWindow.Title")
        };
    ...
    public static async Task InitializeAsync(AsyncPackage package)
    {
        ...
        _ = new ShowCopperfinCommandWindowCommand(package, commandService);
    }
    ...
    private async Task ShowAsync()
    {
        ...
        {
            throw new InvalidOperationException(
                CopperfinLocalization.FromVisualStudioUiCulture().Text("VSIX.CommandWindow.Unavailable"));
        }
    }
}
