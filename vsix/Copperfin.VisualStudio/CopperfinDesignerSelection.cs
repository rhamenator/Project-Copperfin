...
internal sealed class CopperfinDesignerSelection : ICustomTypeDescriptor
{
    ...
    private static IEnumerable<ReportSettingDescriptor> GetKnownReportSettingDescriptors()
    {
        ...
        yield return new ReportSettingDescriptor { Name = "PAPERLENGTH", LocalizationKey = "AssetEditor.Property.PaperLength", Numeric = true, MaterializeWhenMissing = true, RequiresSnapshotPropertyPresence = true };
        yield return new ReportSettingDescriptor { Name = "PAPERWIDTH", LocalizationKey = "AssetEditor.Property.PaperWidth", Numeric = true, MaterializeWhenMissing = true, RequiresSnapshotPropertyPresence = true };
