...
4. `docs/23-phase-a-dependency-breakdown.md` for current lane status plus historical dependency evidence.
5. `docs/22-vfp-language-reference-coverage.md` when the chosen slice touches VFP/runtime language coverage.
