...
- AST/IR outputs: #42
- Build artifact breadth and round-trip safety: #38, #39, #40, #41 (`#418`, `#419`, `#420`, `#421`, `#422`, `#423`, `#424`, `#425`, `#426`, and `#427` have now tightened the honest native-wrapper scaffold/build/export-validation/output-identity/output-placement/build-orchestration/pipeline-integration chain under `#40`; no prompt-sized child queue is currently open on this branch, and `#162`-`#177` shipped earlier in the build/debug lane)
