...
- For issue #8: `&stem.suffix` dot-terminated macro form SHIPPED (wave 5, 47f66d3). Remaining macro edge cases: nested double-macro `&&`, macro in parameter default expressions, macro in `FOR <expr>` clause inside SQL-style commands.
