...
// no-delete-share handles retain every renameable Windows directory below the
// stable drive/UNC root through the image parent, and a final path reopen must
// still match the exact
