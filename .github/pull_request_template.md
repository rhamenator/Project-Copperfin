...
> Use this default template for most contributions: bug fixes, features, tests,
> tooling, or docs that aren't part of the requirements-recovery effort. If
> your change is safety-relevant or tied to `RQ-*`/`VR-*` traceability, use the
> **Requirements Recovery / Traceability** template instead.
