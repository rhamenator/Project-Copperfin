...
namespace copperfin::runtime_surface_tests
{
    void test_same_prg_native_bindevent_property_access_and_assign_dispatch_preserve_current_event_metadata()
    {
        ...
        write_text(
            ...
            "nBindCaption = BINDEVENT(oCreate, 'Caption', 'HandleCaption', 1)\n"
            "nBindRaw = BINDEVENT(oCreate, 'nRaw', 'HandleRaw', 0)\n"
    ...
    void test_property_read_handler_releasing_source_fails_catchably()
    {
        ...
        write_text(
            ...
            "nBind1 = BINDEVENT(oSource, 'Caption', 'ReleaseSource', 0)\n"
            "nBind2 = BINDEVENT(oSource, 'Caption', 'SecondHandler', 0)\n"
            "nErrBefore = 0\n"
            "TRY\n"
            ...
            "oSource = CREATEOBJECT('SourceThing')\n"
            "nBind3 = BINDEVENT(oSource, 'Caption', 'AfterRelease', 1)\n"
            "nErrAfter = 0\n"
            "cAfter = ''\n"
            "TRY\n"
            ...
            "nBind4 = BINDEVENT(oForm.lblChild, 'Caption', 'ReleaseForm', 0)\n"
            "nErrContainer = 0\n"
            "TRY\n"
    ...
    void test_method_before_handler_releasing_source_fails_catchably()
    {
        ...
        write_text(
            ...
            "nBind1 = BINDEVENT(oSource, 'Ping', oHandler, 'ReleaseSource', 0)\n"
            "nBind2 = BINDEVENT(oSource, 'Ping', oHandler, 'SecondHandler', 0)\n"
            "nErrBefore = 0\n"
            "xBefore = ''\n"
            "TRY\n"
            ...
            "oSource = CREATEOBJECT('SourceThing')\n"
            "nBind3 = BINDEVENT(oSource, 'Ping', oHandler, 'AfterRelease', 1)\n"
            "nErrAfter = 0\n"
            "xAfter = ''\n"
            "TRY\n"
            "    xAfter = oSource.Ping()\n"
            ...
            "nBind4 = BINDEVENT(oSelf, 'Ping', oHandler, 'NoopHandler', 0)\n"
            "nErrSelf = 0\n"
            "xSelf = ''\n"
            "TRY\n"
            "    xSelf = oSelf.Ping()\n"
            ...
            "oSource = CREATEOBJECT('SourceThing')\n"
            "oSource.cTag = 'old'\n"
            "nBind5 = BINDEVENT(oSource, 'Ping', oHandler, 'ReplaceSource', 0)\n"
            "nErrReplace = 0\n"
            "TRY\n"
            ...
            "nPings = 0\n"
            "oSource = CREATEOBJECT('SourceThing')\n"
            "nBind6 = BINDEVENT(oSource, 'Ping', oHandler, 'UnbindThenRelease', 0)\n"
            "nErrUnbind = 0\n"
            "TRY\n"
            ...
            "nBind7 = BINDEVENT(oBox.oChild, 'Ping', oHandler, 'RemoveChild', 0)\n"
            "nErrBox = 0\n"
            "xBox = ''\n"
            "TRY\n"
