...
namespace copperfin::runtime_surface_tests
{
    void test_inherited_owner_release_recursively_destroys_declarative_external_base_child_subtree_and_invalidates_owner_chain()
    {
        ...
        const fs::path temp_root = fs::temp_directory_path() / "copperfin_inherited_release_owner_declarative_external_base_child_subtree";
        ...
        const fs::path main_path = temp_root / "inherited_release_owner_declarative_external_base_child_subtree.prg";
        write_text(
            main_path,
            "cDestroyLog = ''\n"
            ...
            "lDictSet = SETPEM(oDict, 'comparemode', 118)\n"
        ...
        expect(state.completed,
               std::string("inherited owner Release declarative external-base child subtree script should complete: ") + state.message +
        ...
        expect(child_after_release != state.globals.end() &&
               ...
               "inherited owner Release declarative external-base child subtree should invalidate GETPEM() for the released child slot");
        ...
        expect(child_parent_after_release != state.globals.end() &&
               ...
               "inherited owner Release declarative external-base child subtree should invalidate GETPEM() for the released child's Parent");
        ...
        expect(child_class_library_after_release != state.globals.end() &&
               ...
               "inherited owner Release declarative external-base child subtree should invalidate GETPEM() for the released child's ClassLibrary");
        ...
        expect(grandchild_parent_after_release != state.globals.end() &&
               ...
               "inherited owner Release declarative external-base child subtree should invalidate GETPEM() for the released grandchild's Parent");
        ...
        expect(form_caption_after_release != state.globals.end() &&
               ...
               "inherited owner Release declarative external-base child subtree should invalidate GETPEM() for the released owner");

        expect(state.ole_objects.size() == 1U,
               "inherited owner Release declarative external-base child subtree should leave only the COM object registered after recursive release");
        if (state.ole_objects.size() == 1U)
        {
            expect(state.ole_objects[0].prog_id == "Scripting.Dictionary",
                   "COM NEWOBJECT should remain stable while inherited owner declarative external-base Release lands");
        }
        ...
        expect(has_grandchild_destroy_event,
               "inherited owner Release declarative external-base child subtree should dispatch the grandchild Destroy method");
        ...
        expect(has_child_destroy_event,
               "inherited owner Release declarative external-base child subtree should dispatch the child Destroy method");
        ...
        expect(has_form_destroy_event,
               "inherited owner Release declarative external-base child subtree should dispatch the owner Destroy method");
