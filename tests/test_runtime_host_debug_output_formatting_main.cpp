...
void test_runtime_host_session_messages_follow_explicit_locale(const std::string& runtime_host_path);
...
int main(int argc, char** argv) {
    ...
    run_runtime_host_test("session message localization", runtime_host_path, test_runtime_host_session_messages_follow_explicit_locale);
