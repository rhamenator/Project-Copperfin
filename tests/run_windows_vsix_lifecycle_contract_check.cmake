...
string(REGEX MATCHALL "SendWait\\('\\^%a'\\)" command_window_shortcuts "${script_contents}")
list(LENGTH command_window_shortcuts command_window_shortcut_count)
if(NOT command_window_shortcut_count EQUAL 2)
    message(FATAL_ERROR "Command-window helper must load and then refocus the surface")
endif()
