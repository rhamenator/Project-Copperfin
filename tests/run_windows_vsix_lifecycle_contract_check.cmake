...
require_text("${script}" "SendWait('%t')" "Visual Studio Tools access-key activation")
require_text("${script}" "[System.Windows.Automation.InvokePattern]::Pattern" "user-visible command invocation")
require_text("${script}" "Observed same-process menu items" "failure-path menu diagnostics")
