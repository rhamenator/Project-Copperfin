...
require_text("${script}" "End package load [Visual Studio Common IDE Package]" "exact Command-window readiness boundary")
require_text("${script}" "'-ActivityLogPath', $activityLog" "runner-owned readiness evidence")
require_text("${script}" "could not be refocused for Command-window input" "post-readiness foreground identity")
