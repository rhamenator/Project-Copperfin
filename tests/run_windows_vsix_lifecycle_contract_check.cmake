...
require_text("${script}" "SendCommandWindowShortcut" "Win32 Command Window shortcut injection")
require_text("${script}" "SendUnicodeTextAndEnter" "Win32 canonical-command injection")
require_text("${script}" "KEYEVENTF_UNICODE" "layout-independent command text input")
require_text("${script}" "SendInput inserted" "fail-closed injected-event count")
require_text("${script}" "Self-test did not compile the generated Win32 input source" "generated Win32 input compile regression")
require_text("${script}" "Self-test found an invalid Win32 INPUT structure size" "generated Win32 INPUT layout regression")
require_text("${script}" "command_window_shortcut_sent" "machine-readable Command Window shortcut state")
require_text("${script}" "shortcut_input_events_injected" "machine-readable shortcut event count")
...
require_text("${script}" "command_input_events_injected" "machine-readable command event count")
