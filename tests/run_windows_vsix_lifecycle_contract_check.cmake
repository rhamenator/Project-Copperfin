...
require_text("${script}" "!VisualStudio.DTE.$RegistryVersion`:$ExpectedProcessId" "process-specific ROT moniker")
require_text("${script}" "GetRunningObjectTable" "Running Object Table enumeration")
require_text("${script}" "-ExpectedProcessId', \"$($ideProcess.Id)\"" "launched-process identity binding")
require_text("${script}" "Expected PRG document was not open" "exact PRG-open proof")
require_text("${script}" "ExecuteCommand($CommandName)" "same-instance registered-command invocation")
