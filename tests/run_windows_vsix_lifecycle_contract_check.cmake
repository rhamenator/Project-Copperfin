...
require_text("${script}" "InvokeToolsMenuItem" "installed Tools-menu command activation")
require_text("${script}" "[System.Windows.Automation.ExpandCollapsePattern]::Pattern" "Tools-menu expansion")
require_text("${script}" "[System.Windows.Automation.InvokePattern]::Pattern" "menu-command invocation")
require_text("${script}" "tools_menu_observed" "machine-readable Tools-menu observation state")
require_text("${script}" "command_menu_item_observed" "machine-readable installed-command observation state")
require_text("${script}" "command_invoked" "machine-readable command invocation state")
...
require_text("${script}" "[System.Windows.Forms.SendKeys]::SendWait('%t')" "bounded English Tools-menu accelerator")
require_text("${script}" "tools_keyboard_accelerator_sent" "machine-readable Tools accelerator state")
...
require_text("${script}" "'/NoSplash', '/Log', $activityLog, $fixturePrg" "single-process startup document routing")
...
string(FIND "${script_contents}" "Copperfin Tools-menu command UI Automation observation" command_observation_offset)
