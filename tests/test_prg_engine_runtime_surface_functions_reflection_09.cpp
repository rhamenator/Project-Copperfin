...
namespace copperfin::runtime_surface_tests
{
    void test_inherited_external_base_object_block_external_child_base_dotted_access_resolves_live_child_chain()
    {
        ...
        const fs::path temp_root = fs::temp_directory_path() / "copperfin_external_base_inherited_object_block_external_child_base_dotted";
        ...
        const fs::path main_path = temp_root / "external_base_inherited_object_block_external_child_base_dotted.prg";
        write_text(
            main_path,
        ...
        expect(state.completed,
               std::string("external-base inherited object-block external child-base dotted script should complete: ") + state.message +
        ...
        expect(state.ole_objects.size() == 5U,
               "external-base inherited object-block external child-base dotted should register CREATEOBJECT parent/child, NEWOBJECT parent/child, and COM objects");
        if (state.ole_objects.size() == 5U)
        {
            ...
            expect(create_parent.prog_id == "ChildForm",
                   "external-base inherited object-block external child-base dotted should preserve CREATEOBJECT parent identity");
            expect(create_parent.source == main_path.string(),
                   "external-base inherited object-block external child-base dotted should preserve CREATEOBJECT parent source");
            expect(create_child.prog_id == "SaveButton",
                   "external-base inherited object-block external child-base dotted should preserve CREATEOBJECT child identity");
            expect(create_child.base_class_name == "ParentButton",
                   "external-base inherited object-block external child-base dotted should preserve the CREATEOBJECT child immediate external base");
            expect(create_child.source == button_library_path.string(),
                   "external-base inherited object-block external child-base dotted should preserve CREATEOBJECT child definition source");
            expect(create_child.class_library == root_library_path.string(),
                   "external-base inherited object-block external child-base dotted should preserve CREATEOBJECT child ClassLibrary path");
            expect(leaf_parent.prog_id == "LeafForm",
                   "external-base inherited object-block external child-base dotted should preserve NEWOBJECT leaf identity");
            expect(leaf_parent.source == main_path.string(),
                   "external-base inherited object-block external child-base dotted should preserve NEWOBJECT leaf source");
            expect(leaf_child.prog_id == "SaveButton",
                   "external-base inherited object-block external child-base dotted should preserve leaf child identity");
            expect(leaf_child.base_class_name == "ParentButton",
                   "external-base inherited object-block external child-base dotted should preserve the leaf child immediate external base");
            expect(leaf_child.source == button_library_path.string(),
                   "external-base inherited object-block external child-base dotted should preserve leaf child definition source");
            expect(leaf_child.class_library == root_library_path.string(),
                   "external-base inherited object-block external child-base dotted should preserve leaf child ClassLibrary path");
            ...
            if (create_parent_caption != create_parent.properties.end())
            {
                expect(copperfin::runtime::format_value(create_parent_caption->second) == "Done-Saved",
                       "external-base inherited object-block external child-base dotted should let dotted child method calls update the CREATEOBJECT owner");
            }
            else
            {
                expect(false, "external-base inherited object-block external child-base dotted should preserve the CREATEOBJECT owner caption");
            }
            if (create_child_caption != create_child.properties.end())
            {
                expect(copperfin::runtime::format_value(create_child_caption->second) == "Go",
                       "external-base inherited object-block external child-base dotted should preserve the CREATEOBJECT child dotted assignment");
            }
            else
            {
                expect(false, "external-base inherited object-block external child-base dotted should preserve the CREATEOBJECT child caption");
            }
            if (leaf_parent_caption != leaf_parent.properties.end())
            {
                expect(copperfin::runtime::format_value(leaf_parent_caption->second) == "Ready-Saved",
                       "external-base inherited object-block external child-base dotted should let dotted child method calls update the leaf owner");
            }
            else
            {
                expect(false, "external-base inherited object-block external child-base dotted should preserve the leaf owner caption");
            }
            if (leaf_child_caption != leaf_child.properties.end())
            {
                expect(copperfin::runtime::format_value(leaf_child_caption->second) == "Ship",
                       "external-base inherited object-block external child-base dotted should preserve the leaf child dotted assignment");
            }
            else
            {
                expect(false, "external-base inherited object-block external child-base dotted should preserve the leaf child caption");
            }
            expect(state.ole_objects[4].prog_id == "Scripting.Dictionary",
                   "COM NEWOBJECT should remain stable while external-base inherited object-block external child-base dotted lands");
        }
        ...
        expect(has_addobject_event,
               "external-base inherited object-block external child-base dotted should emit child materialization events");
        ...
        expect(has_owner_caption_invoke_event,
               "external-base inherited object-block external child-base dotted should dispatch direct dotted child method calls");
        ...
        expect(has_save_invoke_event,
               "external-base inherited object-block external child-base dotted should keep child THISFORM owner dispatch stable");
    ...
    {
        namespace fs = std::filesystem;
        const fs::path temp_root = fs::temp_directory_path() / "copperfin_external_base_inherited_object_block_external_child_base_identity";
        std::error_code ignored;
        fs::remove_all(temp_root, ignored);
        fs::create_directories(temp_root);
        ...
        const fs::path main_path = temp_root / "external_base_inherited_object_block_external_child_base_identity.prg";
        write_text(
            main_path,
            "oCreate = CREATEOBJECT('ChildForm')\n"
            "oLeaf = NEWOBJECT('LeafForm')\n"
        ...
        const auto state = session.run(copperfin::runtime::DebugResumeAction::continue_run);
        expect(state.completed,
               std::string("external-base inherited object-block external child-base identity script should complete: ") + state.message +
                   " @line=" + std::to_string(state.location.line));
        ...
        check("ccreatechildclasslibraryreflect", root_library_path.string());
        ...
        expect(state.ole_objects.size() == 5U,
               "external-base inherited object-block external child-base identity should register CREATEOBJECT parent/child, NEWOBJECT parent/child, and COM objects");
        if (state.ole_objects.size() == 5U)
        {
            const auto &create_parent = state.ole_objects[0];
            const auto &create_child = state.ole_objects[1];
            ...
            const auto &leaf_child = state.ole_objects[3];
            expect(create_parent.prog_id == "ChildForm",
                   "external-base inherited object-block external child-base identity should preserve CREATEOBJECT parent identity");
            expect(create_parent.source == main_path.string(),
                   "external-base inherited object-block external child-base identity should preserve CREATEOBJECT parent source");
            expect(create_child.prog_id == "SaveButton",
                   "external-base inherited object-block external child-base identity should preserve CREATEOBJECT child identity");
            expect(create_child.base_class_name == "ParentButton",
                   "external-base inherited object-block external child-base identity should preserve the CREATEOBJECT child immediate external base");
            expect(create_child.source == button_library_path.string(),
                   "external-base inherited object-block external child-base identity should preserve CREATEOBJECT child source identity");
            expect(create_child.class_library == root_library_path.string(),
                   "external-base inherited object-block external child-base identity should preserve CREATEOBJECT child ClassLibrary path");
            expect(create_child.class_hierarchy.size() == 4U,
                   "external-base inherited object-block external child-base identity should preserve CREATEOBJECT child class hierarchy");
            if (create_child.class_hierarchy.size() == 4U)
            {
                expect(create_child.class_hierarchy[0] == "SAVEBUTTON",
                       "external-base inherited object-block external child-base identity should store the CREATEOBJECT child class first");
                expect(create_child.class_hierarchy[1] == "PARENTBUTTON",
                       "external-base inherited object-block external child-base identity should store the immediate external base second");
                expect(create_child.class_hierarchy[2] == "CUSTOM",
                       "external-base inherited object-block external child-base identity should store the builtin base token third");
                expect(create_child.class_hierarchy[3] == "OBJECT",
                       "external-base inherited object-block external child-base identity should store the terminal object token fourth");
            }
            expect(!create_child.properties.contains("class"),
                   "external-base inherited object-block external child-base identity should not materialize a CREATEOBJECT child Class shadow");
            expect(!create_child.properties.contains("baseclass"),
                   "external-base inherited object-block external child-base identity should not materialize a CREATEOBJECT child BaseClass shadow");
            expect(!create_child.properties.contains("parentclass"),
                   "external-base inherited object-block external child-base identity should not materialize a CREATEOBJECT child ParentClass shadow");
            expect(!create_child.properties.contains("classlibrary"),
                   "external-base inherited object-block external child-base identity should not materialize a CREATEOBJECT child ClassLibrary shadow");
            expect(leaf_parent.prog_id == "LeafForm",
                   "external-base inherited object-block external child-base identity should preserve NEWOBJECT leaf identity");
            expect(leaf_parent.source == main_path.string(),
                   "external-base inherited object-block external child-base identity should preserve NEWOBJECT leaf source");
            expect(leaf_child.prog_id == "SaveButton",
                   "external-base inherited object-block external child-base identity should preserve leaf child identity");
            expect(leaf_child.base_class_name == "ParentButton",
                   "external-base inherited object-block external child-base identity should preserve the leaf child immediate external base");
            expect(leaf_child.source == button_library_path.string(),
                   "external-base inherited object-block external child-base identity should preserve leaf child source identity");
            expect(leaf_child.class_library == root_library_path.string(),
                   "external-base inherited object-block external child-base identity should preserve leaf child ClassLibrary path");
            expect(leaf_child.class_hierarchy.size() == 4U,
                   "external-base inherited object-block external child-base identity should preserve leaf child class hierarchy");
            expect(!leaf_child.properties.contains("class"),
                   "external-base inherited object-block external child-base identity should not materialize a leaf child Class shadow");
            expect(!leaf_child.properties.contains("baseclass"),
                   "external-base inherited object-block external child-base identity should not materialize a leaf child BaseClass shadow");
            expect(!leaf_child.properties.contains("parentclass"),
                   "external-base inherited object-block external child-base identity should not materialize a leaf child ParentClass shadow");
            expect(!leaf_child.properties.contains("classlibrary"),
                   "external-base inherited object-block external child-base identity should not materialize a leaf child ClassLibrary shadow");
            expect(state.ole_objects[4].prog_id == "Scripting.Dictionary",
                   "COM NEWOBJECT should remain stable while external-base inherited object-block external child-base identity lands");
        }
        ...
        expect(has_addobject_event,
               "external-base inherited object-block external child-base identity should emit child materialization events");
        ...
        expect(has_save_invoke_event,
               "external-base inherited object-block external child-base identity should keep child owner dispatch usable after ordinary reads and reflection");
    ...
    {
        namespace fs = std::filesystem;
        const fs::path temp_root = fs::temp_directory_path() / "copperfin_external_base_inherited_object_block_external_child_base_identity_mutation";
        std::error_code ignored;
        fs::remove_all(temp_root, ignored);
        fs::create_directories(temp_root);
        ...
        const fs::path main_path = temp_root / "external_base_inherited_object_block_external_child_base_identity_mutation.prg";
        write_text(
            main_path,
            "oCreate = CREATEOBJECT('ChildForm')\n"
            "oLeaf = NEWOBJECT('LeafForm')\n"
        ...
        const auto state = session.run(copperfin::runtime::DebugResumeAction::continue_run);
        expect(state.completed,
               std::string("external-base inherited object-block external child-base identity mutation script should complete: ") + state.message +
                   " @line=" + std::to_string(state.location.line));
        ...
        check("ccreatechildclasslibraryafter", root_library_path.string());
        ...
        check("ccreatechildclasslibraryreflectafter", root_library_path.string());
        ...
        check("cleafchildclasslibraryafter", root_library_path.string());
        ...
        check("cleafchildclasslibraryreflectafter", root_library_path.string());
        check("ccreateownercaption", "MainForm");
        check("cleafownercaption", "MainForm");
        check("ccreatesavedcaption", "MainForm-Saved");
        check("cleafsavedcaption", "MainForm-Saved");
        ...
        expect(state.ole_objects.size() == 5U,
               "external-base inherited object-block external child-base identity mutation should register CREATEOBJECT parent/child, NEWOBJECT parent/child, and COM objects");
        if (state.ole_objects.size() == 5U)
        {
            const auto &create_parent = state.ole_objects[0];
            const auto &create_child = state.ole_objects[1];
            ...
            const auto &leaf_child = state.ole_objects[3];
            expect(create_parent.prog_id == "ChildForm",
                   "external-base inherited object-block external child-base identity mutation should preserve CREATEOBJECT parent identity");
            expect(create_child.prog_id == "SaveButton",
                   "external-base inherited object-block external child-base identity mutation should preserve CREATEOBJECT child identity");
            expect(create_child.base_class_name == "ParentButton",
                   "external-base inherited object-block external child-base identity mutation should preserve the CREATEOBJECT child immediate external base");
            expect(create_child.source == button_library_path.string(),
                   "external-base inherited object-block external child-base identity mutation should preserve CREATEOBJECT child source identity");
            expect(create_child.class_library == root_library_path.string(),
                   "external-base inherited object-block external child-base identity mutation should preserve CREATEOBJECT child ClassLibrary path");
            expect(create_child.class_hierarchy.size() == 4U,
                   "external-base inherited object-block external child-base identity mutation should preserve CREATEOBJECT child class hierarchy");
            expect(!create_child.properties.contains("class"),
                   "external-base inherited object-block external child-base identity mutation should not materialize a CREATEOBJECT child Class shadow");
            expect(!create_child.properties.contains("baseclass"),
                   "external-base inherited object-block external child-base identity mutation should not materialize a CREATEOBJECT child BaseClass shadow");
            expect(!create_child.properties.contains("parentclass"),
                   "external-base inherited object-block external child-base identity mutation should not materialize a CREATEOBJECT child ParentClass shadow");
            expect(!create_child.properties.contains("classlibrary"),
                   "external-base inherited object-block external child-base identity mutation should not materialize a CREATEOBJECT child ClassLibrary shadow");
            expect(leaf_parent.prog_id == "LeafForm",
                   "external-base inherited object-block external child-base identity mutation should preserve NEWOBJECT leaf identity");
            expect(leaf_child.prog_id == "SaveButton",
                   "external-base inherited object-block external child-base identity mutation should preserve leaf child identity");
            expect(leaf_child.base_class_name == "ParentButton",
                   "external-base inherited object-block external child-base identity mutation should preserve the leaf child immediate external base");
            expect(leaf_child.source == button_library_path.string(),
                   "external-base inherited object-block external child-base identity mutation should preserve leaf child source identity");
            expect(leaf_child.class_library == root_library_path.string(),
                   "external-base inherited object-block external child-base identity mutation should preserve leaf child ClassLibrary path");
            expect(leaf_child.class_hierarchy.size() == 4U,
                   "external-base inherited object-block external child-base identity mutation should preserve leaf child class hierarchy");
            expect(!leaf_child.properties.contains("class"),
                   "external-base inherited object-block external child-base identity mutation should not materialize a leaf child Class shadow");
            expect(!leaf_child.properties.contains("baseclass"),
                   "external-base inherited object-block external child-base identity mutation should not materialize a leaf child BaseClass shadow");
            expect(!leaf_child.properties.contains("parentclass"),
                   "external-base inherited object-block external child-base identity mutation should not materialize a leaf child ParentClass shadow");
            expect(!leaf_child.properties.contains("classlibrary"),
                   "external-base inherited object-block external child-base identity mutation should not materialize a leaf child ClassLibrary shadow");
            expect(state.ole_objects[4].prog_id == "Scripting.Dictionary",
                   "COM NEWOBJECT should remain stable while external-base inherited object-block external child-base identity mutation lands");
        }
        ...
        expect(has_save_invoke_event,
               "external-base inherited object-block external child-base identity mutation should keep child owner dispatch usable after rejected mutations");
