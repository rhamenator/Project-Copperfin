...
void test_library_output_package_emits_module_definition_from_prg_routines() {
    ...
    if (result.ok) {
        ...
        expect(wrapper_source.find("const bool keeps_placeholder_return_active =") != std::string::npos,
               "library-output wrapper source should have the helper derive placeholder activation from the routed mode contract");
        expect(wrapper_source.find("placeholder_return_value_plan.activation_mode == \"planned_activation_pending\";") != std::string::npos,
               "library-output wrapper source should have the helper consume the activation-mode contract");
        expect(wrapper_source.find("placeholder_return_value_plan.adoption_mode == \"replace_placeholder_return\";") != std::string::npos,
               "library-output wrapper source should have the helper consume the adoption-mode contract");
        ...
        expect(wrapper_source.find("placeholder_return_value_plan.emits_placeholder_return") != std::string::npos,
               "library-output wrapper source should have the helper consume the placeholder-emission flag contract");
        ...
        expect(wrapper_source.find("{std::to_string(-1), \"int\"}") != std::string::npos,
               "library-output wrapper source should preserve the DLL placeholder return binding");
        ...
        expect(wrapper_source.find("\"return_value\"") != std::string::npos,
               "library-output wrapper source should declare response payload field names");
        expect(wrapper_source.find("\"status\"") != std::string::npos,
               "library-output wrapper source should declare the response status field mapping");
        ...
        expect(wrapper_source.find("std::to_string(-1)") != std::string::npos,
               "library-output wrapper source should declare the fallback return value policy");
...
void test_fll_output_package_emits_api_manifest_from_prg_routines() {
    ...
    if (result.ok) {
        ...
        expect(wrapper_source.find("const bool keeps_placeholder_return_active =") != std::string::npos,
               "fll-output wrapper source should have the helper derive placeholder activation from the routed mode contract");
        expect(wrapper_source.find("placeholder_return_value_plan.activation_mode == \"planned_activation_pending\";") != std::string::npos,
               "fll-output wrapper source should have the helper consume the activation-mode contract");
        expect(wrapper_source.find("placeholder_return_value_plan.adoption_mode == \"replace_placeholder_return\";") != std::string::npos,
               "fll-output wrapper source should have the helper consume the adoption-mode contract");
        expect(wrapper_source.find("(void)placeholder_return_value_plan.emitted_return_statement;") != std::string::npos,
        ...
        expect(wrapper_source.find("placeholder_return_value_plan.emits_placeholder_return") != std::string::npos,
               "fll-output wrapper source should have the helper consume the placeholder-emission flag contract");
        expect(wrapper_source.find("const auto outcome_selection_plan = copperfin_build_runtime_bridge_outcome_selection_plan(") != std::string::npos,
        ...
        expect(wrapper_source.find("{std::to_string(-1), \"_RetInt(int)\"}") != std::string::npos,
               "fll-output wrapper source should preserve the FLL placeholder return binding");
        expect(wrapper_source.find("{\"COPPERFIN_LIBRARY_EXPORT\", result.call.invocation.descriptor.export_name}") != std::string::npos,
        ...
        expect(wrapper_source.find("\"return_value\"") != std::string::npos,
               "fll-output wrapper source should declare response payload field names");
        expect(wrapper_source.find("\"status\"") != std::string::npos,
               "fll-output wrapper source should declare the response status field mapping");
        expect(wrapper_source.find("\"diagnostics\"") != std::string::npos,
        ...
        expect(wrapper_source.find("std::to_string(-1)") != std::string::npos,
               "fll-output wrapper source should declare the fallback return value policy");
        expect(wrapper_source.find("\"ok\"") != std::string::npos,
