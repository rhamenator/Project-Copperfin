...
int main()
{
    ...
    test_sys16_preserves_procedure_context();
    ...
    test_eventhandler_binds_only_host_admitted_local_source();
    test_eventhandler_drains_admitted_external_tokens_on_runtime_thread();
    ...
    test_native_showtips_defaults_mutate_and_stay_builtin();
    test_native_form_whatsthishelp_defaults_mutate_and_stay_builtin();
    test_native_form_size_limits_defaults_mutate_and_stay_builtin();
    ...
    test_native_listbox_autohidescrollbar_property_stays_builtin();
        test_native_list_control_selectors_reject_partial_integer_tokens();
        test_native_list_control_internal_item_ids_reject_partial_tokens();
    ...
    test_external_prg_base_methods_support_dodefault_dispatch();
        ...
        test_native_keypress_optiongroup_windows_navigation();
    ...
    test_newid_uuid_text_is_locale_invariant();
