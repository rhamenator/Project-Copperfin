...
int main()
{
    ...
    test_native_removeobject_destroys_subtree_and_invalidates_references();
    ...
    test_external_prg_base_methods_support_dodefault_dispatch();
        ...
        test_bindevent_flag_timing_matches_vfp9();
        test_bindevent_flag_timing_matches_vfp9_property_write();
