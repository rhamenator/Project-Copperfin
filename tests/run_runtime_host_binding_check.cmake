...
set(separator_expected_startup "${separator_content_root}/main.prg")
cmake_path(NATIVE_PATH separator_expected_startup NORMALIZE separator_expected_startup)
...
if(separator_startup_position EQUAL -1)
    message(FATAL_ERROR "Runtime host did not rebind a serialized Windows startup path to the logical deployed package identity.\nstdout:\n${separator_run_output}")
endif()
