...
int main()
{
    ...
    test_scan_replace_loop_updates_every_record_at_scale();
    ...
    test_delete_all_for_expression_closing_target_cursor_fails_catchably();
    test_recall_all_and_delete_from_for_expression_closing_target_cursor_fails_catchably();
    ...
    test_table_buffered_replace_null_persists_through_tableupdate();
    ...
    test_session_destruction_rolls_back_transactions_in_every_data_session();
