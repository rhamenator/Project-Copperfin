...
int main(int argc, char** argv) {
    ...
    test_studio_host_json_assigns_drag_mode_by_stable_selectors(argv[1]);
    ...
    test_studio_host_json_assigns_buffer_mode_override_by_stable_selectors(argv[1]);
    test_studio_host_json_assigns_data_session_by_stable_selectors(argv[1]);
    test_studio_host_json_assigns_grid_line_color_by_stable_selectors(argv[1]);
    test_studio_host_json_assigns_header_height_by_stable_selectors(argv[1]);
    test_studio_host_json_assigns_row_height_by_stable_selectors(argv[1]);
    test_studio_host_json_assigns_lock_columns_by_stable_selectors(argv[1]);
    test_studio_host_json_assigns_lock_columns_left_by_stable_selectors(argv[1]);
    test_studio_host_json_assigns_grid_line_width_by_stable_selectors(argv[1]);
    test_studio_host_json_assigns_grid_lines_by_stable_selectors(argv[1]);
    ...
    test_studio_host_json_assigns_column_order_by_stable_selectors(argv[1]);
    test_studio_host_json_assigns_highlight_style_by_stable_selectors(argv[1]);
    test_studio_host_json_assigns_child_order_by_stable_selectors(argv[1]);
    ...
    test_studio_host_json_assigns_tab_orientation_by_stable_selectors(argv[1]);
    ...
    test_studio_host_json_assigns_whats_this_button_by_stable_selectors(argv[1]);
