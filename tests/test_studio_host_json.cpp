...
int main(int argc, char** argv) {
    ...
    test_studio_host_toolbox_dispatch_create_parse_diagnostics_localize(argv[1]);
    test_studio_host_toolbox_batch_dispatch_parse_diagnostics_localize(argv[1]);
    test_studio_host_toolbox_batch_dispatch_plan_parse_diagnostics_localize(argv[1]);
    ...
    test_studio_host_toolbox_batch_create_direct_parse_diagnostics_localize(argv[1]);
    ...
    test_studio_host_launch_dimension_border_target_selector_value_diagnostics_localize(argv[1]);
    test_studio_host_launch_window_picture_target_selector_value_diagnostics_localize(argv[1]);
    test_studio_host_launch_dynamic_target_selector_value_diagnostics_localize(argv[1]);
    test_studio_host_launch_font_target_selector_value_diagnostics_localize(argv[1]);
    test_studio_host_launch_max_selection_target_selector_value_diagnostics_localize(argv[1]);
    test_studio_host_launch_marker_sizing_zorder_target_selector_value_diagnostics_localize(argv[1]);
    ...
    test_studio_host_json_updates_deleted_detail_header_footer_section_expressions_by_stable_selection(argv[1]);
    ...
    test_studio_host_json_exposes_selected_group_footer_label_sections_by_record_selection(argv[1]);
    ...
    test_studio_host_json_updates_group_section_expressions_by_stable_selection(argv[1]);
    test_studio_host_json_exposes_selected_summary_report_sections_by_record_selection(argv[1]);
    test_studio_host_json_exposes_selected_summary_label_sections_by_record_selection(argv[1]);
    test_studio_host_json_exposes_selected_deleted_summary_report_sections_by_record_selection(argv[1]);
    test_studio_host_json_exposes_selected_deleted_summary_label_sections_by_record_selection(argv[1]);
    test_studio_host_json_exposes_selected_title_report_sections_by_record_selection(argv[1]);
    test_studio_host_json_exposes_selected_title_label_sections_by_record_selection(argv[1]);
    test_studio_host_json_exposes_selected_deleted_title_report_sections_by_record_selection(argv[1]);
    test_studio_host_json_exposes_selected_deleted_title_label_sections_by_record_selection(argv[1]);
    test_studio_host_json_exposes_selected_page_footer_report_sections_by_record_selection(argv[1]);
    ...
    test_studio_host_json_exposes_selected_deleted_column_header_label_sections_by_record_selection(argv[1]);
    ...
    test_studio_host_json_exposes_deleted_report_column_header_sections_by_stable_selection(argv[1]);
    test_studio_host_json_exposes_report_column_footer_sections_by_stable_selection(argv[1]);
    test_studio_host_json_exposes_deleted_report_column_footer_sections_by_stable_selection(argv[1]);
    ...
    test_studio_host_json_updates_deleted_report_group_footer_expressions(argv[1]);
    ...
    test_studio_host_json_aligns_live_edited_report_layout_object_geometry_by_stable_selection(argv[1]);
    ...
    test_studio_host_json_resizes_live_edited_report_layout_object_geometry_by_stable_selection(argv[1]);
    ...
    test_studio_host_json_snaps_live_edited_report_layout_object_geometry_by_stable_selection(argv[1]);
    ...
    test_studio_host_json_restores_live_edited_then_deleted_report_layout_object_geometry_by_record_selection(argv[1]);
    test_studio_host_json_restores_live_edited_unplaced_then_deleted_report_layout_object_geometry_by_record_selection(argv[1]);
    ...
    test_studio_host_json_reorders_live_edited_unplaced_report_layout_object_geometry_by_record_selection(argv[1]);
    ...
    test_studio_host_json_duplicates_live_edited_unplaced_report_layout_object_geometry_by_record_selection(argv[1]);
    ...
    test_studio_host_json_clears_deleted_report_layout_object_height_by_stable_selection(argv[1]);
    ...
    test_studio_host_json_updates_deleted_report_layout_object_top_by_stable_selection(argv[1]);
    test_studio_host_json_clears_deleted_report_layout_object_top_by_stable_selection(argv[1]);
    test_studio_host_json_restores_edited_deleted_report_layout_object_geometry_by_record_selection(argv[1]);
    test_studio_host_json_restores_edited_deleted_report_layout_object_geometry_by_stable_selection(argv[1]);
    ...
    test_studio_host_json_exposes_selected_deleted_page_footer_report_objects_by_stable_selection(argv[1]);
    test_studio_host_json_exposes_selected_column_header_report_objects_by_stable_selection(argv[1]);
    test_studio_host_json_exposes_selected_deleted_column_header_report_objects_by_stable_selection(argv[1]);
    test_studio_host_json_exposes_selected_column_footer_report_objects_by_stable_selection(argv[1]);
    test_studio_host_json_exposes_selected_deleted_column_footer_report_objects_by_stable_selection(argv[1]);
    ...
    test_studio_host_json_exposes_selected_deleted_detail_report_objects_orphaned_by_deleted_sections(argv[1]);
    ...
    test_studio_host_json_reorders_visual_property_batches(argv[1]);
    ...
    test_studio_host_json_creates_toolbox_object_batches_from_palette_dispatch(argv[1]);
    ...
    test_studio_host_json_plans_selection_toolbox_object_creation_dispatch_catalog(argv[1]);
    ...
    test_studio_host_json_copies_deleted_report_visual_properties_by_stable_selection(argv[1]);
    ...
    test_studio_host_json_assigns_multi_select_by_stable_selectors(argv[1]);
    ...
    test_studio_host_json_assigns_mouse_pointer_by_stable_selectors(argv[1]);
    test_studio_host_json_assigns_picture_margin_by_stable_selectors(argv[1]);
    ...
    test_studio_host_json_assigns_dynamic_font_bold_by_stable_selectors(argv[1]);
    test_studio_host_json_assigns_dynamic_font_italic_by_stable_selectors(argv[1]);
    test_studio_host_json_assigns_dynamic_font_underline_by_stable_selectors(argv[1]);
    test_studio_host_json_assigns_dynamic_font_strikethru_by_stable_selectors(argv[1]);
    test_studio_host_json_assigns_dynamic_font_outline_by_stable_selectors(argv[1]);
    test_studio_host_json_assigns_dynamic_font_shadow_by_stable_selectors(argv[1]);
    ...
    test_studio_host_json_assigns_font_shadow_by_stable_selectors(argv[1]);
