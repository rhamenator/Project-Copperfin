...
void write_synthetic_report_table_for_layout_json(const std::filesystem::path& report_path) {
    ...
    expect(create_result.ok, "#2832: layout fixture should be created");

    const auto delete_result = copperfin::vfp::set_record_deleted_flag(report_path.string(), 6U, true);
    expect(delete_result.ok, "#2832: layout fixture should mark deleted layout objects");
}
...
void write_synthetic_report_table_for_deleted_settings_json(const std::filesystem::path& report_path) {
    ...
    expect(delete_result.ok, "#2832: synthetic FRX table should mark report settings deleted");
}

void test_studio_host_json_preserves_selected_report_settings(const std::string& studio_host_path) {
    namespace fs = std::filesystem;
    ...
    expect_contains(settings_process.stdout_text, "\"paperLengthAvailable\": true",
                    "#3744: selected report settings JSON should expose paper-length availability");
    expect_contains(settings_process.stdout_text, "\"paperLength\": 2794",
                    "#3744: selected report settings JSON should preserve paper-length values");
    ...
    expect_contains(settings_process.stdout_text, "\"name\": \"PAPERLENGTH\", \"recordIndex\": 0, \"fieldIndex\": 2, \"sourceLineIndex\": 2, \"memoBlockNumber\": 1, \"value\": \"2794\"",
                    "#3744: selected report settings should expose memo-line paper-length provenance");
    expect_contains(settings_process.stdout_text, "\"name\": \"PAPERWIDTH\", \"recordIndex\": 0, \"fieldIndex\": 2, \"sourceLineIndex\": 3, \"memoBlockNumber\": 1, \"value\": \"2159\"",
                    "#3744: selected report settings should expose memo-line paper-width provenance");
    ...
    expect_contains(deleted_settings_process.stdout_text, "\"orientationAvailable\": true",
                    "#3815: deleted selected report settings JSON should surface fallback orientation availability");
    expect_contains(deleted_settings_process.stdout_text, "\"orientationCode\": 0",
                    "#3815: deleted selected report settings JSON should surface fallback orientation values");
    expect_contains(deleted_settings_process.stdout_text, "\"paperSizeAvailable\": true",
                    "#3815: deleted selected report settings JSON should surface fallback paper-size availability");
    expect_contains(deleted_settings_process.stdout_text, "\"paperSizeCode\": 1",
                    "#3815: deleted selected report settings JSON should surface fallback paper-size values");
    expect_contains(deleted_settings_process.stdout_text, "\"paperLengthAvailable\": true",
                    "#3815: deleted selected report settings JSON should surface fallback paper-length availability");
    expect_contains(deleted_settings_process.stdout_text, "\"paperLength\": 2794",
                    "#3815: deleted selected report settings JSON should surface fallback paper-length values");
    expect_contains(deleted_settings_process.stdout_text, "\"paperWidthAvailable\": true",
                    "#3815: deleted selected report settings JSON should surface fallback paper-width availability");
    expect_contains(deleted_settings_process.stdout_text, "\"paperWidth\": 2159",
                    "#3815: deleted selected report settings JSON should surface fallback paper-width values");
    expect_contains(deleted_settings_process.stdout_text, "\"topMarginAvailable\": true",
                    "#3815: deleted selected report settings JSON should surface fallback top-margin availability");
    expect_contains(deleted_settings_process.stdout_text, "\"topMargin\": 10",
                    "#3815: deleted selected report settings JSON should surface fallback top-margin values");
    expect_contains(deleted_settings_process.stdout_text, "\"bottomMarginAvailable\": true",
                    "#3815: deleted selected report settings JSON should surface fallback bottom-margin availability");
    expect_contains(deleted_settings_process.stdout_text, "\"bottomMargin\": 20",
                    "#3815: deleted selected report settings JSON should surface fallback bottom-margin values");
    expect_contains(deleted_settings_process.stdout_text, "\"leftMarginAvailable\": true",
                    "#3815: deleted selected report settings JSON should surface fallback left-margin availability");
    expect_contains(deleted_settings_process.stdout_text, "\"leftMargin\": 15",
                    "#3815: deleted selected report settings JSON should surface fallback left-margin values");
    expect_contains(deleted_settings_process.stdout_text, "\"rightMarginAvailable\": true",
                    "#3815: deleted selected report settings JSON should surface fallback right-margin availability");
    expect_contains(deleted_settings_process.stdout_text, "\"rightMargin\": 25",
                    "#3815: deleted selected report settings JSON should surface fallback right-margin values");
    expect_contains(deleted_settings_process.stdout_text, "\"gridVerticalAvailable\": true",
                    "#3815: deleted selected report settings JSON should surface fallback vertical-grid availability");
    expect_contains(deleted_settings_process.stdout_text, "\"gridVertical\": 4",
                    "#3815: deleted selected report settings JSON should surface fallback vertical-grid values");
    expect_contains(deleted_settings_process.stdout_text, "\"gridHorizontalAvailable\": true",
                    "#3815: deleted selected report settings JSON should surface fallback horizontal-grid availability");
    expect_contains(deleted_settings_process.stdout_text, "\"gridHorizontal\": 8",
                    "#3815: deleted selected report settings JSON should surface fallback horizontal-grid values");
...
int main(int argc, char** argv) {
    if (argc < 2) {
        std::cerr << "Usage: test_studio_host_selected_report_settings <studio_host_path>\n";
        return 1;
    }

    test_studio_host_json_preserves_selected_report_settings(argv[1]);
