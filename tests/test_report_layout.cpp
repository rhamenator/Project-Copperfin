...
int main() {
    ...
    test_report_image_offset_provenance();
    test_report_object_tooltip_provenance();
    test_report_line_shape_style_provenance();
    test_report_font_charset_provenance();
    ...
    test_report_header_curpos_provenance();
    test_report_header_unique_provenance();
