...
void write_synthetic_report_table_for_stable_title_section_json(
    ...
    expect(create_result.ok, "#2808: stable page-footer section fixture should be created");
}

void run_page_footer_section_stable_selection(
...
void run_deleted_page_footer_section_stable_selection(
    const std::string& studio_host_path,
    const std::filesystem::path& temp_root,
    const std::string& file_name,
    const std::string& label,
...
void test_studio_host_json_preserves_selected_page_footer_sections_stable_selection(
    const std::string& studio_host_path) {
    namespace fs = std::filesystem;

    const fs::path temp_root =
        fs::temp_directory_path() / "copperfin_studio_host_selected_page_footer_sections_stable_tests";
    ...
    run_page_footer_section_stable_selection(
        studio_host_path,
        temp_root,
        "stable_page_footer_sections.frx",
        "report",
        "#2808: stable-selected live report page-footer section selection");
    run_page_footer_section_stable_selection(
        studio_host_path,
        temp_root,
        "stable_page_footer_sections.lbx",
        "label",
        "#2808: stable-selected live label page-footer section selection");
    run_deleted_page_footer_section_stable_selection(
        studio_host_path,
        temp_root,
        "stable_deleted_page_footer_sections.frx",
        "report",
        "#2808: stable-selected deleted report page-footer section selection");
    run_deleted_page_footer_section_stable_selection(
        studio_host_path,
        temp_root,
        "stable_deleted_page_footer_sections.lbx",
        "label",
        "#2808: stable-selected deleted label page-footer section selection");
...
int main(int argc, char** argv) {
    if (argc < 2) {
        std::cerr << "Usage: test_studio_host_selected_page_footer_sections_stable <studio_host_path>\n";
        return 1;
    }

    test_studio_host_json_preserves_selected_page_footer_sections_stable_selection(argv[1]);
