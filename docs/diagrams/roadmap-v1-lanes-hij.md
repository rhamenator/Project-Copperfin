...
`H3`/`I2` still lack model/provider and OAuth adapters, mutable execution and
sandbox enforcement, host UI, and audit commit integration. **What's left, and what it
takes:** this is
