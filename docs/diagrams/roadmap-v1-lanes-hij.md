...
flowchart TB
    ...
    subgraph V1["v1 Roadmap"]
      ...
      subgraph LANEH["Lane H - root #113 'Modernization/outputs/interop/security' (shared root with I)"]
        ...
        H3["H3 .NET Outputs, MCP/AI<br/>Hooks, Python/R Sidecars<br/>root #32 - SEEDED:<br/>Native AOT + Python leaves<br/>+ benchmarked route impact"]
        H1 --> H2 --> H3
      end
...
Native AOT leaf, admitted Python sidecar leaf, advisory measured-route strategy,
...
`H3` still lacks R, broader managed-language, and product MCP/AI adapters. **What's left, and what it
takes:** this is
