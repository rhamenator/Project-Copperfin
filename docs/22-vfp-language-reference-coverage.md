...
- `SQLCONNECT()`, `SQLSTRINGCONNECT()`, `SQLEXEC()`, `SQLDISCONNECT()`, `SQLROWCOUNT()`, `SQLPREPARE()`, first-pass `SQLGETPROP()`, `SQLSETPROP()`, `SQLCANCEL()`, `SQLCOMMIT()`, `SQLROLLBACK()`, `SQLTABLES()`, and `SQLCOLUMNS()`
