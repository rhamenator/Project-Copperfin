...
- `#24` currently has no open prompt-sized children after `#1452`-`#1526` have implementation evidence; create the next native child before more E3 implementation work.
