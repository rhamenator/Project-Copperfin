...
environment policy. It performs no platform serialization, environment
construction, sandboxing, or launch and returns no authority.
...
launch-adjacent target pinning/revalidation, isolated-environment construction,
platform argument serialization, endpoint policy, the mutable agent executor
