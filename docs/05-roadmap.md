...
an opaque private native image while retaining the plan, pins, and lease;
portable exact-snapshot execution and its platform launch transition remain
open.
