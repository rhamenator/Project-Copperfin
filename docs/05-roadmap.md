...
- `#24` currently has no open prompt-sized children after `#1452`-`#1547` closed; create the next native child before more E3 implementation work unless the live issue tree shows a higher-weight blocker.
