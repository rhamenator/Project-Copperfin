...
- live execution is centered on E3/#24 report/label designer fidelity, where latest shipped child `#2353` covers negative-dimension preview-metadata JSON coverage; localization/#2348 has landed through `#2352` and now constrains new user-facing text; E2/#23 remains open mainly for evidence-backed audit/closure cleanup of already implemented designer host slices
