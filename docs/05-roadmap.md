...
gate; private immutable byte snapshots are now authenticated, while exact-
snapshot executor consumption and its synchronous combination with the lease
remain open.
