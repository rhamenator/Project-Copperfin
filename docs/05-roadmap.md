...
logical entries and the next portable boundary serializes them for POSIX or
Windows. These preflights perform no argument serialization, sandboxing, or
launch and return no authority.
