...
- VSIX UI: continue moving dialogs, pane body text, project/debugger detail text, and status text into shared resources while preserving VS command IDs.
