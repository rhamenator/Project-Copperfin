...
- Latest implemented E2 slice: `#1310`, which adds selected-context toolbox object batch creation execution in the design-model seam. Issue closure still requires explicit user approval if the standing no-close-without-approval rule is active.
