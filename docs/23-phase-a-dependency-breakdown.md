...
- Latest implemented E3 slice: `#2043`, stable object deleted-states preview-metadata coverage. Recent adjacent E3 implementation slices through `#2042`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
