...
- Latest implemented E3 slice: `#2279`, live detail header/footer object expression selection preview-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2278`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
