...
- Latest implemented E3 slice: `#2265`, stable-selected deleted detail header/footer section expression mutation-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2264`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
