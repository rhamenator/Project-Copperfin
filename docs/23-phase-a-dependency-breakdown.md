...
- Latest implemented E3 slice: `#2121`, label selection toolbox create-plan coverage. Recent adjacent E3 implementation slices through `#2120`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
