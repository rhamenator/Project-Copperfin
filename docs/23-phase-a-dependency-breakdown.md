...
- Latest implemented E3 slice: `#1978`, selected deleted summary report object preview-metadata coverage. Recent adjacent E3 implementation slices through `#1977`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
