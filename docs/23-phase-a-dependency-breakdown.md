...
- Latest implemented E2 slice: `#1255`, which adds non-mutating toolbox object batch creation dispatch catalog planning. Issue closure still requires explicit user approval if the standing no-close-without-approval rule is active.
