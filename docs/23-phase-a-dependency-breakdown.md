...
- Latest implemented E3 slice: `#2160`, deleted report/label visual-property copy-batch undo-label JSON coverage. Recent adjacent E3 implementation slices through `#2159`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
