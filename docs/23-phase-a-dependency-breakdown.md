...
- Latest implemented E3 slice: `#2306`, deleted detail header/footer object vertical distribution preview-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2305`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
