...
- Latest implemented localization slice: `#2538`, local `USE` target resolution errors. Continue prompt-sized localization/#2348 cleanup before returning to ordinary E3/#24 feature children unless blocked.
