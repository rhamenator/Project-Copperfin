...
- Latest implemented E3 slice: `#1922`, stable-selected deleted report/label section height clear preview-metadata coverage. Recent adjacent E3 batch/stable-selector slices through `#1921`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
