...
- Latest implemented E3 slice: `#2273`, section delete preview-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2272`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
