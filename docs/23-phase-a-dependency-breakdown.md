...
- Latest implemented E3 slice: `#2112`, report selection toolbox create-dispatch catalog coverage. Recent adjacent E3 implementation slices through `#2111`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
