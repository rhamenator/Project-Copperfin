...
- Latest implemented E3 slice: `#2187`, deleted report/label visual-property clear failure undo-state JSON coverage. Recent adjacent E3 implementation slices through `#2186`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
