...
| --- | --- | --- |
| `#24` | `#1520` implemented; closure pending | Studio host JSON exposes compact non-mutating report/label live and deleted section band-kind summary counts while preserving detailed layout payloads |
