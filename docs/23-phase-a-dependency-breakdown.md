...
- Latest implemented E3 slice: `#2091`, explicit label toolbox create-from-dispatch routing coverage. Recent adjacent E3 implementation slices through `#2090`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
