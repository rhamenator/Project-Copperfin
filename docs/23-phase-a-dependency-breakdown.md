...
- Latest implemented E3 slice: `#1880`, stable-selected live edited unplaced report/label layout-object reorder preview-metadata coverage. Recent adjacent E3 batch/stable-selector slices through `#1879`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
