...
- Latest implemented E3 slice: `#2041`, stable-selected settings delete/restore preview-metadata coverage. Recent adjacent E3 implementation slices through `#2040`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
