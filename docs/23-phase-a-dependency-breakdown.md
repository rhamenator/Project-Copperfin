...
- Latest implemented E2 slice: `#1201`, which exposes host deleted-states batch commands by stable target selectors. Issue closure still requires explicit user approval if the standing no-close-without-approval rule is active.
