...
- Latest implemented E3 slice: `#2044`, stable mixed deleted-states preview-metadata coverage. Recent adjacent E3 implementation slices through `#2043`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
