...
- Latest implemented E3 slice: `#1884`, stable-selected live edited report/label layout-object align preview-metadata coverage. Recent adjacent E3 batch/stable-selector slices through `#1883`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
...
| `#24` | `#1884` closed | Studio host regressions prove stable-selected live edited report/label layout-object alignment preserves live and deleted preview bounds while refreshing selected-object geometry |
