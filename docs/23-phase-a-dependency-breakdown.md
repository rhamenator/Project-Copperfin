...
| --- | --- | --- |
| `#22` | `#680` | preserve project entry classification field provenance |
...
- `#22`: complete `#680`, then continue by opening the next shared design-model child if no open child remains
...
22. `#679`
23. `#680`
24. next prompt-sized child under `#22`
25. continue the live open umbrella queue under `#23`-`#43`, `#57`, and `#91` by dependency weight
