...
- Latest implemented E3 slice: `#2259`, deleted detail header/footer object vertical distribution mutation-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2258`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
