...
- Latest implemented E3 slice: `#2212`, failed deleted report/label visual-property clear mutation-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2211`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
