...
- Latest implemented E3 slice: `#1879`, stable-selected live Detail Header/Footer report/label section reorder preview-metadata coverage. Recent adjacent E3 batch/stable-selector slices through `#1878`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
