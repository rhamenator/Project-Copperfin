...
- Latest implemented E3 slice: `#2194`, deleted report/label visual-property geometry move JSON coverage. Recent adjacent E3 implementation slices through `#2193`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
