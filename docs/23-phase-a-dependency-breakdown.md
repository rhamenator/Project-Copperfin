...
- Latest implemented E3 slice: `#2264`, deleted detail header/footer section expression mutation-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2263`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
