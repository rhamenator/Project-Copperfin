...
- Latest implemented E3 slice: `#1987`, selected deleted group-footer label section preview-metadata coverage. Recent adjacent E3 implementation slices through `#1986`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
