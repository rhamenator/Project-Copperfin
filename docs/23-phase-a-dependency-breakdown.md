...
- Latest implemented E2 slice: `#1275`, which adds non-executing selection-context builder/wizard dispatch catalog planning. Issue closure still requires explicit user approval if the standing no-close-without-approval rule is active.
