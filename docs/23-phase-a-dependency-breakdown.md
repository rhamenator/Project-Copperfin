...
- Latest implemented E3 slice: `#2030`, record-selected column-count mutation preview-metadata coverage. Recent adjacent E3 implementation slices through `#2029`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
