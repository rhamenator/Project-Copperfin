...
- Latest implemented E2 slice: `#1229`, which adds non-executing builder/wizard invocation dispatch planning for admitted builder invocations. Issue closure still requires explicit user approval if the standing no-close-without-approval rule is active.
