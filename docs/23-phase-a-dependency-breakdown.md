...
- Latest implemented E3 slice: `#2149`, stable report selection toolbox create-dispatch catalog field payload coverage. Recent adjacent E3 implementation slices through `#2148`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
