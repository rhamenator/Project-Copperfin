...
- Latest implemented E3 slice: `#1891`, stable-selected edited deleted report/label layout-object restore preview-metadata coverage. Recent adjacent E3 batch/stable-selector slices through `#1890`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
...
| `#24` | `#1891` closed | Studio host regressions prove stable-selected edited deleted report/label layout-object restores refresh live preview bounds and clear deleted preview availability when no deleted objects remain |
