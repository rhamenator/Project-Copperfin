...
- Latest implemented E3 slice: `#2126`, label selection toolbox create-dispatch catalog coverage. Recent adjacent E3 implementation slices through `#2125`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
