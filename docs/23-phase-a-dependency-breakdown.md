...
- Latest implemented E3 slice: `#2118`, report selection toolbox batch create-dispatch plan coverage. Recent adjacent E3 implementation slices through `#2117`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
