...
- Latest shipped E2 slice: `#1023`, which exposes host delete-object commands by record index, object name, or unique id.
...
| --- | --- | --- |
| `#23` | open next child | continue designer interaction, builder, and context-aware editor fidelity after `#1023` |
...
- `#23`: `#1023` is shipped; continue by opening the next prompt-sized designer interaction/builder/context-aware editor child if no open child remains
