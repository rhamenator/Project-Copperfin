...
- Latest implemented E3 slice: `#2262`, live detail header/footer section expression mutation-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2261`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
