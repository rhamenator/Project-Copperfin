...
- Latest implemented E2 slice: `#1194`, which exposes host dynamic-font-outline-object commands by stable target selectors. Issue closure still requires explicit user approval if the standing no-close-without-approval rule is active.
