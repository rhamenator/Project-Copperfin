...
- Latest implemented E2 slice: `#1254`, which exposes non-mutating toolbox object creation dispatch catalogs through Studio host JSON. Issue closure still requires explicit user approval if the standing no-close-without-approval rule is active.
