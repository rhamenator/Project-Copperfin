...
- Latest implemented E3 slice: `#1857`, stable-selected report/label visual-object subtree deleted-state coverage for flat FRX/LBX layout object rows. Recent adjacent E3 batch/stable-selector slices through `#1845`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
