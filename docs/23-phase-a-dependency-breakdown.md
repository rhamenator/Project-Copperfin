...
- Latest implemented E3 slice: `#2050`, stable live object rename-batch preview-metadata coverage. Recent adjacent E3 implementation slices through `#2049`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
