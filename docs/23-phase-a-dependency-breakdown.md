...
- Latest implemented E3 slice: `#1888`, edited report/label layout-object restore preview-metadata coverage. Recent adjacent E3 batch/stable-selector slices through `#1887`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
...
| `#24` | `#1888` closed | Studio host regressions prove edited report/label layout-object restores refresh live preview bounds with the restored edited object and preserve deleted preview bounds for remaining deleted objects |
