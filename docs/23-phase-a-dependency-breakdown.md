...
- Latest implemented E3 slice: `#2054`, stable live object reorder-batch preview-metadata coverage. Recent adjacent E3 implementation slices through `#2053`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
