...
- Latest implemented E3 slice: `#2294`, deleted detail header/footer object reorder preview-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2293`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
