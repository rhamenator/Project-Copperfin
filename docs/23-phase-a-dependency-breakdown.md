...
- Latest implemented E3 slice: `#2096`, explicit label toolbox batch create-from-dispatch routing coverage. Recent adjacent E3 implementation slices through `#2095`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
