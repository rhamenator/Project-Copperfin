...
- Latest implemented E3 slice: `#2026`, record-selected horizontal-grid mutation preview-metadata coverage. Recent adjacent E3 implementation slices through `#2025`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
