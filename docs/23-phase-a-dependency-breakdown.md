...
| --- | --- | --- |
| `#22` | `#665` | preserve report-object geometry provenance |
...
- `#22`: continue by opening the next shared design-model child after `#665` closes
...
7. `#664`
8. `#665`
9. next prompt-sized child under `#22`
10. continue the live open umbrella queue under `#23`-`#43`, `#57`, and `#91` by dependency weight
