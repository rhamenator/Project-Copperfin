...
- Latest implemented E2 slice: `#1248`, which exposes Studio-layer toolbox object batch creation through Studio host JSON. Issue closure still requires explicit user approval if the standing no-close-without-approval rule is active.
