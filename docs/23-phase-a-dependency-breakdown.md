...
- Latest implemented E3 slice: `#2237`, deleted detail header/footer section top-update mutation-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2236`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
