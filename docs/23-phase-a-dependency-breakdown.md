...
- Latest implemented E3 slice: `#1928`, stable deleted Detail Header/Footer report/label section expression preview-metadata coverage. Recent adjacent E3 implementation slices through `#1927`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
