...
| --- | --- | --- |
| `#22` | `#671` | preserve raw visual metadata field provenance |
...
- `#22`: complete `#671`, then continue by opening the next shared design-model child if no open child remains
...
13. `#670`
14. `#671`
15. next prompt-sized child under `#22`
16. continue the live open umbrella queue under `#23`-`#43`, `#57`, and `#91` by dependency weight
