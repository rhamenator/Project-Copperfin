...
- Latest implemented E3 slice: `#2255`, deleted detail header/footer object nudge mutation-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2254`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
