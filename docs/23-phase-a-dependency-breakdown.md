...
- Latest implemented E3 slice: `#2042`, stable deleted-states settings/section preview-metadata coverage. Recent adjacent E3 implementation slices through `#2041`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
