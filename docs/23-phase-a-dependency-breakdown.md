...
- Latest implemented E2 slice: `#1309`, which exposes selected-context toolbox object creation execution through Studio host JSON. Issue closure still requires explicit user approval if the standing no-close-without-approval rule is active.
