...
- Latest implemented E3 slice: `#2361`, editor-action label/description/error localization for report/label designer-facing action catalogs. Recent adjacent E3 implementation slices through `#2360`-`#1799` are shipped; keep their evidence in changelog/current-status records instead of repeating it in recurring handoff text.
