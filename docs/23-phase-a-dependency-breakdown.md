...
- Latest implemented E2 slice: `#1136`, which exposes host form-set-class-object commands by stable target selectors. Issue closure still requires explicit user approval if the standing no-close-without-approval rule is active.
