...
- Latest implemented E3 slice: `#2067`, stable deleted summary object preview-metadata coverage. Recent adjacent E3 implementation slices through `#2066`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
