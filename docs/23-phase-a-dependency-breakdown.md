...
- Latest implemented E3 slice: `#2173`, live report/label visual-object duplicate-subtree empty undo-label JSON coverage. Recent adjacent E3 implementation slices through `#2172`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
