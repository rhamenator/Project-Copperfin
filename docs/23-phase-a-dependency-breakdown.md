...
- Latest implemented E2 slice: `#1253`, which adds non-mutating toolbox object creation dispatch catalog planning across toolbox contexts. Issue closure still requires explicit user approval if the standing no-close-without-approval rule is active.
