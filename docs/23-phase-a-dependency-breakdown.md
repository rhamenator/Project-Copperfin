...
- Latest implemented E3 slice: `#2283`, deleted detail header/footer object font mutation preview-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2282`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
