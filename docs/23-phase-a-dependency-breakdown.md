...
- Latest implemented E3 slice: `#2270`, deleted group section expression mutation preview-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2269`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
