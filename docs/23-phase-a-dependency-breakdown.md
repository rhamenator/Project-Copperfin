...
| --- | --- | --- |
| `#22` | `#660` | preserve design-object identity and hierarchy metadata |
...
- `#22`: continue by opening the next shared design-model child after `#660` closes
...
2. `#659`
3. `#660`
4. next prompt-sized child under `#22`
5. continue the live open umbrella queue under `#23`-`#43`, `#57`, and `#91` by dependency weight
