...
- Latest implemented E3 slice: `#1901`, stable-selected report/label layout-object left clear deleted-preview coverage. Recent adjacent E3 batch/stable-selector slices through `#1900`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
