...
- Latest implemented E3 slice: `#2156`, stable report/label visual-object update-batch undo-label JSON coverage. Recent adjacent E3 implementation slices through `#2155`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
