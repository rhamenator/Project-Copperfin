...
- Latest implemented E3 slice: `#1887`, edited report/label layout-object delete preview-metadata coverage. Recent adjacent E3 batch/stable-selector slices through `#1886`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
...
| `#24` | `#1887` closed | Studio host regressions prove edited report/label layout-object deletes refresh live preview bounds and expand deleted preview bounds with the edited deleted-object geometry |
