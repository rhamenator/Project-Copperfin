...
- Latest implemented E3 slice: `#2278`, detail header section delete/restore preview-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2277`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
