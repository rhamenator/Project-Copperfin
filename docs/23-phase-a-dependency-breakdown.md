...
- Latest implemented E3 slice: `#2155`, stable label selection toolbox batch create-dispatch catalog field payload coverage. Recent adjacent E3 implementation slices through `#2154`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
