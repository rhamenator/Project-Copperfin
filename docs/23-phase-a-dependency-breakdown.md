...
- Latest implemented E3 slice: `#2076`, default report/label expression designer-action metadata coverage. Recent adjacent E3 implementation slices through `#2075`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
