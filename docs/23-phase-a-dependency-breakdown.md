...
- Latest implemented E3 slice: `#2062`, stable deleted visual-property rename rejection preview-metadata coverage. Recent adjacent E3 implementation slices through `#2061`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
