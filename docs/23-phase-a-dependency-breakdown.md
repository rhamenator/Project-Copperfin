...
- Latest implemented E3 slice: `#2302`, deleted detail header/footer object nudge preview-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2301`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
