...
- Latest implemented E2 slice: `#1211`, which adds combined non-executing designer launch-surface planning across editor actions, builders/wizards, and toolbox palettes. Issue closure still requires explicit user approval if the standing no-close-without-approval rule is active.
