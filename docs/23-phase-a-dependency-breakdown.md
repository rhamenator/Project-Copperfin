...
- Latest implemented E3 slice: `#2186`, deleted report/label visual-property clear-batch rollback undo-state JSON coverage. Recent adjacent E3 implementation slices through `#2185`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
