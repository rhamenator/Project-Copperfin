...
- Latest implemented E3 slice: `#2177`, deleted report/label visual-object duplicate-subtree rejection undo-state JSON coverage. Recent adjacent E3 implementation slices through `#2176`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
