...
| --- | --- | --- |
| `#22` | `#666` | preserve report-layout raw type codes |
...
- `#22`: continue by opening the next shared design-model child after `#666` closes
...
8. `#665`
9. `#666`
10. next prompt-sized child under `#22`
11. continue the live open umbrella queue under `#23`-`#43`, `#57`, and `#91` by dependency weight
