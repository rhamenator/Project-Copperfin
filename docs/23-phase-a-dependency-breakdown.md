...
- Latest implemented E3 slice: `#1876`, stable-selected deleted Detail Header/Footer report/label section reorder preview-metadata coverage. Recent adjacent E3 batch/stable-selector slices through `#1875`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
