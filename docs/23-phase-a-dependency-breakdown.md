...
- Latest implemented E2 slice: `#1148`, which exposes host key-preview-object commands by stable target selectors. Issue closure still requires explicit user approval if the standing no-close-without-approval rule is active.
