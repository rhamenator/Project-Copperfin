...
- Latest implemented E3 slice: `#2017`, report/label column setup preview-metadata coverage. Recent adjacent E3 implementation slices through `#2016`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
