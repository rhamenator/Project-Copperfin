...
- Latest implemented E3 slice: `#2058`, stable deleted visual-property move-batch preview-metadata coverage. Recent adjacent E3 implementation slices through `#2057`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
