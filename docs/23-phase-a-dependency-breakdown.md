...
- Latest implemented E3 slice: `#2311`, extended report/label object-kind preview-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2310`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
