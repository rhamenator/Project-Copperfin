...
- Latest implemented E2 slice: `#1145`, which exposes host auto-verb-menu-object commands by stable target selectors. Issue closure still requires explicit user approval if the standing no-close-without-approval rule is active.
