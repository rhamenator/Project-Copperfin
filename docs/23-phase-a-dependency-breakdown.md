...
- Latest implemented E3 slice: `#2028`, record-selected bottom-margin mutation preview-metadata coverage. Recent adjacent E3 implementation slices through `#2027`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
