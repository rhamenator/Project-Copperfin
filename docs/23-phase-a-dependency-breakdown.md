...
- Latest implemented E3 slice: `#2257`, deleted detail header/footer object distribution mutation-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2256`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
