...
| --- | --- | --- |
| `#22` | `#679` | preserve project entry relative path field provenance |
...
- `#22`: complete `#679`, then continue by opening the next shared design-model child if no open child remains
...
21. `#678`
22. `#679`
23. next prompt-sized child under `#22`
24. continue the live open umbrella queue under `#23`-`#43`, `#57`, and `#91` by dependency weight
