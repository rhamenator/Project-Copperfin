...
- Latest implemented E2 slice: `#1243`, which adds non-mutating toolbox object creation plan catalogs for selected toolbox contexts. Issue closure still requires explicit user approval if the standing no-close-without-approval rule is active.
