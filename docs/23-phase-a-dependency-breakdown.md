...
- Latest implemented E3 slice: `#2081`, explicit label toolbox create-plan routing coverage. Recent adjacent E3 implementation slices through `#2080`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
