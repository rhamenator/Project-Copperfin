...
- Latest implemented E3 slice: `#2360`, missing-geometry summary preview-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2359`-`#1799` are shipped; keep their evidence in changelog/current-status records instead of repeating it in recurring handoff text.
