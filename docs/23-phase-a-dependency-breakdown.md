...
- Latest implemented E3 slice: `#2039`, stable-selected settings-memo mutation preview-metadata coverage. Recent adjacent E3 implementation slices through `#2038`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
