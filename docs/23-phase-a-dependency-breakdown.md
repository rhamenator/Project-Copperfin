...
- Latest implemented E3 slice: `#2021`, stable-selected paper-size mutation preview-metadata coverage. Recent adjacent E3 implementation slices through `#2020`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
