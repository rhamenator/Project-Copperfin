...
- Latest implemented E2 slice: `#1183`, which exposes host font-strikethru-object commands by stable target selectors. Issue closure still requires explicit user approval if the standing no-close-without-approval rule is active.
