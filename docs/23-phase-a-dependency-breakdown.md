...
- Latest implemented E3 slice: `#1929`, stable live group-header/footer report/label section expression preview-metadata coverage. Recent adjacent E3 implementation slices through `#1928`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
