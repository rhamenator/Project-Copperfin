...
- Latest implemented E3 slice: `#2085`, explicit label toolbox batch create routing coverage. Recent adjacent E3 implementation slices through `#2084`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
