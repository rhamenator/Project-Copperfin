...
- Latest implemented E3 slice: `#2159`, deleted report/label visual-property copy undo-label JSON coverage. Recent adjacent E3 implementation slices through `#2158`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
