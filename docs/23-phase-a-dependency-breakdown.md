...
- Latest implemented E3 slice: `#2268`, record-selected group section preview-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2267`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
