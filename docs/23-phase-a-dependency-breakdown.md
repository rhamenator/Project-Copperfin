...
- Latest implemented E3 slice: `#2266`, stable-selected deleted detail header/footer section preview-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2265`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
