...
- Latest implemented E3 slice: `#2192`, deleted report/label visual-property geometry clear mutation-state JSON coverage. Recent adjacent E3 implementation slices through `#2191`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
