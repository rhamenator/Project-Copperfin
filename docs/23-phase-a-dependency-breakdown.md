...
- Latest implemented E3 slice: `#2124`, label selection toolbox batch create-dispatch plan coverage. Recent adjacent E3 implementation slices through `#2123`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
