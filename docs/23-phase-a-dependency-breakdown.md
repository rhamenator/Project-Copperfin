...
- Latest implemented E3 slice: `#2178`, live report/label visual-object rename-batch rollback undo-state JSON coverage. Recent adjacent E3 implementation slices through `#2177`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
