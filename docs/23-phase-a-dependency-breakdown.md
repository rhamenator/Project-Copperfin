...
- Latest implemented E3 slice: `#2289`, live detail header/footer object duplicate preview-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2288`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
