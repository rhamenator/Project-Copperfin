...
- Latest implemented E3 slice: `#1932`, stable deleted summary report/label section preview-metadata coverage. Recent adjacent E3 implementation slices through `#1931`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
