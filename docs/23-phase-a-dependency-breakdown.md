...
- Latest implemented E3 slice: `#2129`, label selection toolbox create execution coverage. Recent adjacent E3 implementation slices through `#2128`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
