...
- Latest implemented E3 slice: `#1948`, stable deleted column-footer report/label object preview-metadata coverage. Recent adjacent E3 implementation slices through `#1947`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
