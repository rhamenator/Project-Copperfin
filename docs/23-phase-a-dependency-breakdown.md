...
- Latest implemented E3 slice: `#1890`, edited unplaced report/label layout-object restore preview-metadata coverage. Recent adjacent E3 batch/stable-selector slices through `#1889`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
...
| `#24` | `#1890` closed | Studio host regressions prove edited unplaced report/label layout-object restores refresh live preview bounds with restored out-of-section geometry and preserve deleted preview bounds for remaining deleted objects |
