...
- Latest implemented E2 slice: `#1277`, which adds non-executing selection-context builder/wizard launch catalog planning. Issue closure still requires explicit user approval if the standing no-close-without-approval rule is active.
