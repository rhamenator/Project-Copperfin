...
- Latest implemented E3 slice: `#2284`, live detail header/footer object font option mutation preview-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2283`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
