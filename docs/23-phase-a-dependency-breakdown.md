...
- Latest implemented E3 slice: `#1951`, stable page-header report/label object preview-metadata coverage. Recent adjacent E3 implementation slices through `#1950`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
