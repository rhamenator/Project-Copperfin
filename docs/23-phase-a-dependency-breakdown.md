...
For recency-sensitive wording, treat `CHANGELOG.md` and live GitHub issue state as authoritative for "latest" status; entries below are historical evidence snapshots.
