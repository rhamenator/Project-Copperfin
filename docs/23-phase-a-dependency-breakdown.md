...
- Latest implemented E3 slice: `#1889`, edited unplaced report/label layout-object delete preview-metadata coverage. Recent adjacent E3 batch/stable-selector slices through `#1888`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
...
| `#24` | `#1889` closed | Studio host regressions prove edited unplaced report/label layout-object deletes refresh live preview bounds and expand deleted preview bounds with edited out-of-section geometry |
