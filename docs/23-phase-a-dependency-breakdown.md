...
- Latest implemented E3 slice: `#2218`, failed deleted report/label visual-property rename mutation-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2217`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
