...
- Latest implemented E3 slice: `#2238`, deleted detail header/footer section height-clear mutation-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2237`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
