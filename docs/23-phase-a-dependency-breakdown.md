...
- Latest implemented E2 slice: `#1281`, which adds non-executing selection-context editor-action invocation admission catalog planning. Issue closure still requires explicit user approval if the standing no-close-without-approval rule is active.
