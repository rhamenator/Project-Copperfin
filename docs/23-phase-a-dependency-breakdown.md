...
- Latest implemented E3 slice: `#2167`, deleted report/label visual-object rename-batch undo-label JSON coverage. Recent adjacent E3 implementation slices through `#2166`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
