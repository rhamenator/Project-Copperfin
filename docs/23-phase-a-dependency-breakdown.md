...
- Latest implemented E3 slice: `#2047`, stable deleted-object subtree duplicate preview-metadata coverage. Recent adjacent E3 implementation slices through `#2046`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
