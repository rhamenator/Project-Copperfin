...
- Latest implemented E3 slice: `#2020`, record-selected paper-size mutation preview-metadata coverage. Recent adjacent E3 implementation slices through `#2019`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
