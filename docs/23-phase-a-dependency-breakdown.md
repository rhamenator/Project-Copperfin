...
- Latest implemented E3 slice: `#2065`, stable deleted visual-property reorder-batch rejection preview-metadata coverage. Recent adjacent E3 implementation slices through `#2064`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
