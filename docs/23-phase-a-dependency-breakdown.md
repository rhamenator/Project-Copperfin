...
| --- | --- | --- |
| `#22` | `#704` | normalize PJX project type codes |
...
- `#22`: complete `#704`, then continue by opening the next shared design-model child if no open child remains
...
46. `#703`
47. `#704`
48. next prompt-sized child under `#22`
49. continue the live open umbrella queue under `#23`-`#43`, `#57`, and `#91` by dependency weight
