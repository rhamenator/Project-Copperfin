...
- Latest implemented E3 slice: `#1900`, record-selected report/label layout-object left clear deleted-preview coverage. Recent adjacent E3 batch/stable-selector slices through `#1899`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
