...
| --- | --- | --- |
| `#22` | `#682` | preserve report layout classification field provenance |
...
- `#22`: complete `#682`, then continue by opening the next shared design-model child if no open child remains
...
24. `#681`
25. `#682`
26. next prompt-sized child under `#22`
27. continue the live open umbrella queue under `#23`-`#43`, `#57`, and `#91` by dependency weight
