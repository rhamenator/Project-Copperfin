...
- Latest implemented E3 slice: `#2097`, explicit report toolbox batch create-dispatch-from-dispatch plan routing coverage. Recent adjacent E3 implementation slices through `#2096`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
