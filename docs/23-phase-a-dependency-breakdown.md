...
- Latest implemented E3 slice: `#1926`, evidence-maintenance rows for completed E3/#24 layout-object preview backfill work. Recent adjacent E3 implementation slices through `#1924`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
