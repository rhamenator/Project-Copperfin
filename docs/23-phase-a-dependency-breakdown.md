...
- Latest implemented E3 slice: `#2310`, live detail header/footer object containment preview-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2309`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
