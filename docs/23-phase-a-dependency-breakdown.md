...
| --- | --- | --- |
| `#22` | `#701` | prove UNC project item path normalization |
...
- `#22`: complete `#701`, then continue by opening the next shared design-model child if no open child remains
...
43. `#700`
44. `#701`
45. next prompt-sized child under `#22`
46. continue the live open umbrella queue under `#23`-`#43`, `#57`, and `#91` by dependency weight
