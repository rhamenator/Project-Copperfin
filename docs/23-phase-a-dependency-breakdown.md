...
| --- | --- | --- |
| `#22` | `#664` | preserve report-section geometry provenance |
...
- `#22`: continue by opening the next shared design-model child after `#664` closes
...
6. `#663`
7. `#664`
8. next prompt-sized child under `#22`
9. continue the live open umbrella queue under `#23`-`#43`, `#57`, and `#91` by dependency weight
