...
- Latest implemented E3 slice: `#2271`, deleted group section expression preview-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2270`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
