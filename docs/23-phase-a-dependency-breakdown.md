...
| --- | --- | --- |
| `#22` | `#690` | preserve deleted report layout sections |
...
- `#22`: complete `#690`, then continue by opening the next shared design-model child if no open child remains
...
32. `#689`
33. `#690`
34. next prompt-sized child under `#22`
35. continue the live open umbrella queue under `#23`-`#43`, `#57`, and `#91` by dependency weight
