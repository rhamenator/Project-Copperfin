...
- Latest implemented E2 slice: `#1262`, which adds non-mutating toolbox object batch creation planning from admitted palette dispatch. Issue closure still requires explicit user approval if the standing no-close-without-approval rule is active.
