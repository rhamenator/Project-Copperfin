...
- Latest implemented E3 slice: `#2330`, CR-only settings memo preview-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2329`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
