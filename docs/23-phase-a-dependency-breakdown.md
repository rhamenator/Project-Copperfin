...
- Latest implemented E2 slice: `#1143`, which exposes host whats-this-help-object commands by stable target selectors. Issue closure still requires explicit user approval if the standing no-close-without-approval rule is active.
