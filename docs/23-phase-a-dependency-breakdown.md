...
| --- | --- | --- |
| `#22` | `#698` | use VFP path stems for xAsset menu activation |
...
- `#22`: complete `#698`, then continue by opening the next shared design-model child if no open child remains
...
40. `#697`
41. `#698`
42. next prompt-sized child under `#22`
43. continue the live open umbrella queue under `#23`-`#43`, `#57`, and `#91` by dependency weight
