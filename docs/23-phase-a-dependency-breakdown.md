...
- Latest implemented E3 slice: `#2281`, deleted detail header/footer object font selection preview-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2280`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
