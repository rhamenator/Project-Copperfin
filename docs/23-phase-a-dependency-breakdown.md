...
- Latest implemented E3 slice: `#2337`, missing root expression preview-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2336`-`#1799` are shipped; keep their evidence in changelog/current-status records instead of repeating it in recurring handoff text.
