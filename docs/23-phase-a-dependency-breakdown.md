...
- Latest implemented E3 slice: `#2198`, deleted report/label visual-property geometry move-batch rollback JSON coverage. Recent adjacent E3 implementation slices through `#2197`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
