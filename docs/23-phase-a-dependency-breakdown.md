...
- Latest implemented E3 slice: `#1970`, selected deleted unplaced report object preview-metadata coverage. Recent adjacent E3 implementation slices through `#1969`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
