...
- Latest implemented E3 slice: `#2130`, label selection toolbox batch create execution coverage. Recent adjacent E3 implementation slices through `#2129`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
