...
| --- | --- | --- |
| `#22` | `#663` | preserve project build-plan field provenance |
...
- `#22`: continue by opening the next shared design-model child after `#663` closes
...
5. `#662`
6. `#663`
7. next prompt-sized child under `#22`
8. continue the live open umbrella queue under `#23`-`#43`, `#57`, and `#91` by dependency weight
