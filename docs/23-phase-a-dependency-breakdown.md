...
- Latest implemented E3 slice: `#2022`, record-selected orientation mutation preview-metadata coverage. Recent adjacent E3 implementation slices through `#2021`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
