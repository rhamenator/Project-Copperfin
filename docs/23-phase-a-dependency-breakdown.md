...
- Latest implemented E3 slice: `#2070`, stable group-footer object preview-metadata coverage. Recent adjacent E3 implementation slices through `#2069`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
