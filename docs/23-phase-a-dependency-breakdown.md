...
- Latest implemented E3 slice: `#2025`, stable-selected vertical-grid mutation preview-metadata coverage. Recent adjacent E3 implementation slices through `#2024`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
