...
- Latest implemented E3 slice: `#2216`, failed deleted report/label visual-property move mutation-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2215`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
