...
- Latest implemented E3 slice: `#2016`, stable-selected generic report/label settings preview-metadata coverage. Recent adjacent E3 implementation slices through `#2015`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
