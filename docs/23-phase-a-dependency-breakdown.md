...
- Latest implemented E2 slice: `#1273`, which adds non-executing selection-context builder/wizard invocation-admission catalog planning. Issue closure still requires explicit user approval if the standing no-close-without-approval rule is active.
