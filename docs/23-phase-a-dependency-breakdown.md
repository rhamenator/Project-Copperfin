...
- Latest implemented E3 slice: `#2001`, selected column-header label section preview-metadata coverage. Recent adjacent E3 implementation slices through `#2000`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
