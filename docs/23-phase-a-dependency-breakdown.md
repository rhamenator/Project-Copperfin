...
- Latest implemented E3 slice: `#2345`, unsupported OBJTYPE summary preview-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2344`-`#1799` are shipped; keep their evidence in changelog/current-status records instead of repeating it in recurring handoff text.
