...
- Latest implemented E3 slice: `#1998`, selected deleted page-footer report section preview-metadata coverage. Recent adjacent E3 implementation slices through `#1997`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
