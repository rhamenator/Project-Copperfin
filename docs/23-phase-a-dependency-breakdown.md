...
- Latest implemented E3 slice: `#1863`, stable-selected deleted report/label visual-object update-batch coverage for flat FRX/LBX layout object rows. Recent adjacent E3 batch/stable-selector slices through `#1862`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
