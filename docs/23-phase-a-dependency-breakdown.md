...
- Latest implemented E2 slice: `#1159`, which exposes host half-height-caption-object commands by stable target selectors. Issue closure still requires explicit user approval if the standing no-close-without-approval rule is active.
