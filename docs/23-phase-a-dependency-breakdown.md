...
- Latest implemented E3 slice: `#2217`, failed deleted report/label visual-property move-batch mutation-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2216`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
