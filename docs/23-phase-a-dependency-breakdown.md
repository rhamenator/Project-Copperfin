...
- Latest implemented E3 slice: `#1955`, stable deleted orphaned detail report/label object preview-metadata coverage. Recent adjacent E3 implementation slices through `#1954`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
