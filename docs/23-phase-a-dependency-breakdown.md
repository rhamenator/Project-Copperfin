...
- Latest implemented E2 slice: `#1191`, which exposes host dynamic-font-italic-object commands by stable target selectors. Issue closure still requires explicit user approval if the standing no-close-without-approval rule is active.
