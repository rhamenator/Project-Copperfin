...
- Latest implemented E3 slice: `#1874`, stable-selected deleted Detail Header/Footer report/label section duplicate preview-metadata coverage. Recent adjacent E3 batch/stable-selector slices through `#1873`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
