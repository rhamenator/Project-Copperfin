...
- Latest implemented E3 slice: `#2213`, failed deleted report/label visual-property clear-batch mutation-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2212`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
