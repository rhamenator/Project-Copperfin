...
- Latest implemented E3 slice: `#2036`, record-selected column-setup mutation preview-metadata coverage. Recent adjacent E3 implementation slices through `#2035`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
