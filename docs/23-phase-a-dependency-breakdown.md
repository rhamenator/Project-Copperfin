...
- Latest implemented E3 slice: `#1871`, stable-selected deleted report/label visual-property clear coverage for flat FRX/LBX layout object rows. Recent adjacent E3 batch/stable-selector slices through `#1870`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
