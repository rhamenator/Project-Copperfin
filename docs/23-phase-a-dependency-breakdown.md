...
- Latest implemented E3 slice: `#2276`, detail header/footer section height update preview-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2275`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
