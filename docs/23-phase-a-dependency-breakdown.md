...
- Latest implemented E2 slice: `#1233`, which adds non-executing toolbox palette dispatch planning for admitted toolbox invocations. Issue closure still requires explicit user approval if the standing no-close-without-approval rule is active.
