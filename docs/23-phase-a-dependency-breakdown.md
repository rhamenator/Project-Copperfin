...
- Latest implemented E2 slice: `#1215`, which adds non-executing builder/wizard invocation admission planning. Issue closure still requires explicit user approval if the standing no-close-without-approval rule is active.
