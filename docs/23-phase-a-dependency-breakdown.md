...
- Latest implemented E3 slice: `#2055`, stable deleted object reorder-batch preview-metadata coverage. Recent adjacent E3 implementation slices through `#2054`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
