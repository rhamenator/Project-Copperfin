...
- Latest implemented E3 slice: `#2172`, deleted report/label visual-object reorder-batch empty undo-label JSON coverage. Recent adjacent E3 implementation slices through `#2171`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
