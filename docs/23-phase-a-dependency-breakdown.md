...
- Latest implemented E3 slice: `#2242`, live detail header/footer section duplicate mutation-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2241`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
