...
- Latest implemented E3 slice: `#1957`, selected deleted report settings preview-metadata coverage. Recent adjacent E3 implementation slices through `#1956`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
