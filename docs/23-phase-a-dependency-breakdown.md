...
- Latest implemented E3 slice: `#2291`, live detail header/footer object rename preview-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2290`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
