...
- Latest implemented E3 slice: `#2287`, deleted detail header/footer object geometry mutation preview-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2286`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
