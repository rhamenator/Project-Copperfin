...
- Latest implemented E3 slice: `#2013`, stable-selected deleted page-header report/label section preview-metadata coverage. Recent adjacent E3 implementation slices through `#2012`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
