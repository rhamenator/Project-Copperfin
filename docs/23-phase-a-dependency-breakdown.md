...
- Latest shipped E2 slice: `#1020`, which lets Studio host property edits target visual objects by object name or unique id.
...
| --- | --- | --- |
| `#23` | open next child | continue designer interaction, builder, and context-aware editor fidelity after `#1020` |
...
- `#23`: `#1020` is shipped; continue by opening the next prompt-sized designer interaction/builder/context-aware editor child if no open child remains
