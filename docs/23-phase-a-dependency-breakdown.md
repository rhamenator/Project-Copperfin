...
- Latest implemented E3 slice: `#2002`, selected deleted column-header report section preview-metadata coverage. Recent adjacent E3 implementation slices through `#2001`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
