...
- Latest implemented E3 slice: `#2162`, deleted report/label visual-property move-batch undo-label JSON coverage. Recent adjacent E3 implementation slices through `#2161`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
