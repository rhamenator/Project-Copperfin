...
- Latest implemented E3 slice: `#2083`, explicit label toolbox create-dispatch catalog routing coverage. Recent adjacent E3 implementation slices through `#2082`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
