...
- Latest implemented E3 slice: `#2248`, live detail header/footer object align mutation-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2247`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
