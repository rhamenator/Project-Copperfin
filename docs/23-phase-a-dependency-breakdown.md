...
- Latest implemented E3 slice: `#2234`, live detail header/footer section height-clear mutation-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2233`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
