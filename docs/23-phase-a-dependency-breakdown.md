...
- Latest implemented E3 slice: `#2040`, record-selected settings delete/restore preview-metadata coverage. Recent adjacent E3 implementation slices through `#2039`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
