...
- Latest implemented E3 slice: `#2117`, report selection toolbox create-dispatch plan coverage. Recent adjacent E3 implementation slices through `#2116`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
