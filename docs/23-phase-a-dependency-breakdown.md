...
- Latest implemented E3 slice: `#2051`, stable deleted object rename-batch preview-metadata coverage. Recent adjacent E3 implementation slices through `#2050`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
