...
- Latest implemented E3 slice: `#2240`, live detail header/footer section delete/restore mutation-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2239`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
