...
- Latest implemented E3 slice: `#1909`, stable-selected report/label layout-object top clear deleted-preview coverage. Recent adjacent E3 batch/stable-selector slices through `#1908`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
