...
- Latest implemented E2 slice: `#1217`, which adds non-executing editor-action invocation admission planning. Issue closure still requires explicit user approval if the standing no-close-without-approval rule is active.
