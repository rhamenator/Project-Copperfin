...
- Latest implemented E3 slice: `#2241`, live detail footer section delete/restore preview-bounds mutation-metadata JSON coverage. Recent adjacent E3 implementation slices through `#2240`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
