...
- Latest implemented E2 slice: `#1142`, which exposes host whats-this-help-id-object commands by stable target selectors. Issue closure still requires explicit user approval if the standing no-close-without-approval rule is active.
