...
- Latest implemented E2 slice: `#1318`, which adds the injected builder dispatch execution seam for admitted builder/wizard dispatch contracts. Issue closure still requires explicit user approval if the standing no-close-without-approval rule is active.
