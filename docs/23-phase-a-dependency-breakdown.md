...
- Latest implemented E3 slice: `#1903`, stable-selected report/label layout-object height update deleted-preview coverage. Recent adjacent E3 batch/stable-selector slices through `#1902`-`#1799` are shipped; keep their evidence in the historical tables below instead of repeating it in recurring handoff text.
