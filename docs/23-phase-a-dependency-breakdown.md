...
| --- | --- | --- |
| `#22` | `#681` | preserve project build startup item field provenance |
...
- `#22`: complete `#681`, then continue by opening the next shared design-model child if no open child remains
...
23. `#680`
24. `#681`
25. next prompt-sized child under `#22`
26. continue the live open umbrella queue under `#23`-`#43`, `#57`, and `#91` by dependency weight
